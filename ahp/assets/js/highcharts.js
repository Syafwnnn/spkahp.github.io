...
(function (K, S) {
  "object" === typeof module && module.exports
    ? (module.exports = K.document ? S(K) : S)
    : (K.Highcharts = S(K));
  ...
  K = (function () {
    var a = window,
      ...
      G =
        C &&
        C.createElementNS &&
        !!C.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
  ...
  (function (a) {
    ...
    a.error = function (m, g) {
      m = a.isNumber(m)
        ? "Highcharts error #" + m + ": www.highcharts.com/errors/" + m
        : m;
      if (g) throw Error(m);
    ...
    a.Fx.prototype = {
      dSetter: function () {
        ...
        if (1 === q) k = this.toD;
          ...
          for (; v--; )
            (u = parseFloat(a[v])),
              (k[v] = isNaN(u) ? a[v] : q * parseFloat(g[v] - u) + u);
        else k = g;
      ...
      update: function () {
        ...
        if (this[g + "Setter"]) this[g + "Setter"]();
          ...
          a.attr
            ? a.element && a.attr(g, k, null, !0)
            : (a.style[g] = k + this.unit);
        q && q.call(a, k, this);
      },
      run: function (a, g, k) {
        var m = this,
      ...
      step: function (m) {
        ...
        v.attr && !v.element
          ...
          ? ((this.now = this.end),
            ...
            k && u && u.call(v),
            (m = !1))
          : ((this.pos = q.easing((g - this.startTime) / h)),
      ...
      initPath: function (m, g, k) {
        function q(a) {
          ...
          for (y = a.length; y--; )
            (b = "M" === a[y] || "L" === a[y]),
              ...
              b &&
                l &&
                a.splice(y + 1, 0, a[y + 1], a[y + 2], a[y + 1], a[y + 2]);
        }
        function v(a, b) {
          for (; a.length < w; ) {
            a[0] = b[w - a.length];
            ...
            D &&
              ((l = a.slice(a.length - c)),
              [].splice.apply(a, [a.length, 0].concat(l)),
              y--);
          }
          a[0] = "M";
        }
        function u(a, l) {
          for (var r = (w - a.length) / c; 0 < r && r--; )
            (b = a.slice().splice(a.length / H - c, c * H)),
              (b[0] = l[w - c - r * c]),
              d && ((b[c - 6] = b[c - 2]), (b[c - 5] = b[c - 1])),
    ...
    a.merge = function () {
      var m,
        ...
        v = function (g, h) {
          "object" !== typeof g && (g = {});
          a.objectEach(h, function (e, n) {
            !a.isObject(e, !0) || a.isClass(e) || a.isDOMElement(e)
              ? (g[n] = h[n])
              : (g[n] = v(g[n] || {}, e));
          });
          return g;
    ...
    a.attr = function (m, g, k) {
      ...
      a.isString(g)
        ? a.defined(k)
          ? m.setAttribute(g, k)
          : m && m.getAttribute && (q = m.getAttribute(g))
        : a.defined(g) &&
          a.isObject(g) &&
    ...
    a.css = function (m, g) {
      a.isMS &&
        ...
        g &&
        void 0 !== g.opacity &&
        (g.filter = "alpha(opacity\x3d" + 100 * g.opacity + ")");
      a.extend(m.style, g);
    };
    ...
    a.getTZOffset = function (m) {
      ...
      return (
        6e4 *
        ((g.hcGetTimezoneOffset && g.hcGetTimezoneOffset(m)) ||
          g.hcTimezoneOffset ||
          0)
      );
    };
        ...
        q = a.extend(
          {
            ...
            I: y(u % 12 || 12),
            l: u % 12 || 12,
            M: y(v[q.hcGetMinutes]()),
            p: 12 > u ? "AM" : "PM",
            P: 12 > u ? "am" : "pm",
            S: y(v.getSeconds()),
            L: y(Math.round(g % 1e3), 3),
          },
          a.dateFormats
        );
    ...
    a.normalizeTickInterval = function (m, g, k, q, v) {
      ...
      for (
        ...
        q < g.length &&
        !((h = g[q]),
        (v && h * k >= m) || (!v && u <= (g[q] + (g[q + 1] || g[q])) / 2));
        q++
      );
      return (h = a.correctFloat(
        h * k,
    ...
    a.getStyle = function (m, g, k) {
      if ("width" === g)
        return (
          Math.min(m.offsetWidth, m.scrollWidth) -
          a.getStyle(m, "padding-left") -
          a.getStyle(m, "padding-right")
        );
      if ("height" === g)
        return (
          Math.min(m.offsetHeight, m.scrollHeight) -
          a.getStyle(m, "padding-top") -
          a.getStyle(m, "padding-bottom")
        );
      if ((m = F.getComputedStyle(m, void 0)))
        (m = m.getPropertyValue(g)), a.pick(k, !0) && (m = a.pInt(m));
      return m;
    };
    ...
    a.offset = function (a) {
      ...
      return {
        top: a.top + (F.pageYOffset || g.scrollTop) - (g.clientTop || 0),
        left: a.left + (F.pageXOffset || g.scrollLeft) - (g.clientLeft || 0),
      };
    };
    a.stop = function (a, g) {
    ...
    a.addEvent = function (m, g, k) {
      ...
      m.addEventListener
        ? m.addEventListener(g, k, !1)
        : m.attachEvent &&
          (m.hcEventsIE || (m.hcEventsIE = {}),
          (m.hcEventsIE[k.toString()] = q),
          m.attachEvent("on" + g, q));
      v[g] || (v[g] = []);
      v[g].push(k);
      return function () {
        a.removeEvent(m, g, k);
    ...
    a.removeEvent = function (m, g, k) {
      function q(a, d) {
        m.removeEventListener
          ? m.removeEventListener(a, d, !1)
          : m.attachEvent &&
            ((d = m.hcEventsIE[d.toString()]), m.detachEvent("on" + a, d));
      }
      function v() {
        var e, d;
        m.nodeName &&
          ...
          a.objectEach(e, function (a, e) {
            if (h[e]) for (d = h[e].length; d--; ) q(e, h[e][d]);
          }));
      }
      var u,
        h = m.hcEvents,
    ...
    a.fireEvent = function (m, g, k, q) {
      ...
      var u, h;
      k = k || {};
      if (G.createEvent && (m.dispatchEvent || m.fireEvent))
        (v = G.createEvent("Events")),
          v.initEvent(g, !0, !0),
          a.extend(v, k),
    ...
    a.animate = function (m, g, k) {
      ...
      a.isObject(k) ||
        ((e = arguments),
        (k = { duration: e[2], easing: e[3], complete: e[4] }));
      ...
      a.objectEach(g, function (e, d) {
        ...
        u = null;
        "d" === d
          ? ((h.paths = h.initPath(m, m.d, g.d)),
            (h.toD = g.d),
            (q = 0),
            (u = 1))
          : m.attr
          ? (q = m.attr(d))
          : ((q = parseFloat(a.getStyle(m, d)) || 0),
            "opacity" !== d && (v = "px"));
        u || (u = e);
    ...
    F.jQuery &&
      (F.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return m[0]
            ? (new a[a.isString(m[0]) ? m.shift() : "Chart"](
                this[0],
                m[0],
                m[1]
              ),
    ...
    G &&
      !G.defaultView &&
      (a.getStyle = function (m, g) {
        var k = { width: "clientWidth", height: "clientHeight" }[g];
        if (m.style[g]) return a.pInt(m.style[g]);
        "opacity" === g && (g = "filter");
        if (k)
          return (
            (m.style.zoom = 1), Math.max(m[k] - 2 * a.getStyle(m, "padding"), 0)
          );
        m =
          m.currentStyle[
            g.replace(/\-(\w)/g, function (a, g) {
              return g.toUpperCase();
            })
          ];
        "filter" === g &&
          (m = m.replace(/alpha\(opacity=([0-9]+)\)/, function (a, g) {
            return g / 100;
          }));
        return "" === m ? 1 : a.pInt(m);
      });
    ...
    Array.prototype.indexOf ||
      (a.inArray = function (a, g) {
        var k,
          q = 0;
        if (g) for (k = g.length; q < k; q++) if (g[q] === a) return q;
        return -1;
      });
    ...
    Array.prototype.find ||
      (a.find = function (a, g) {
        var k,
          q = a.length;
        for (k = 0; k < q; k++) if (g(a[k], k)) return a[k];
      });
  })(K);
  (function (a) {
    var C = a.each,
    ...
    a.Color.prototype = {
      ...
      init: function (g) {
        ...
        if (
          (this.input = g =
            this.names[g && g.toLowerCase ? g.toLowerCase() : ""] || g) &&
          g.stops
        )
          this.stops = G(g.stops, function (h) {
          ...
          (g &&
            ...
            7 === k
              ? (q = [(g & 16711680) >> 16, (g & 65280) >> 8, g & 255, 1])
              : 4 === k &&
                (q = [
                  ((g & 3840) >> 4) | ((g & 3840) >> 8),
                  ((g & 240) >> 4) | (g & 240),
      ...
      get: function (a) {
        ...
        this.stops
          ? ((m = F(g)),
            (m.stops = [].concat(m.stops)),
            C(this.stops, function (g, h) {
      ...
      tweenTo: function (a, k) {
        ...
        a.rgba.length
          ? ((g = this.rgba),
            ...
            (a =
              (m ? "rgba(" : "rgb(") +
              Math.round(a[0] + (g[0] - a[0]) * (1 - k)) +
              "," +
              Math.round(a[1] + (g[1] - a[1]) * (1 - k)) +
              "," +
              Math.round(a[2] + (g[2] - a[2]) * (1 - k)) +
              (m ? "," + (a[3] + (g[3] - a[3]) * (1 - k)) : "") +
              ")"))
          : (a = a.input || "none");
        return a;
  ...
  (function (a) {
    ...
    c(C.prototype, {
      ...
      animate: function (x, f, t) {
        ...
        0 !== f.duration
          ? (t && (f.complete = t), F(this, x, f))
          : (this.attr(x, null, t), f.step && f.step.call(this));
        return this;
      },
      colorGradient: function (x, f, t) {
        ...
        x.radialGradient
          ? (c = "radialGradient")
          : x.linearGradient && (c = "linearGradient");
        c &&
          ((r = x[c]),
          (e = b.gradients),
          (n = x.stops),
          ...
          e[J]
            ? (w = e[J].attr("id"))
            : ((r.id = w = a.uniqueKey()),
              (e[J] = h = b.createElement(c).attr(r).add(b.defs)),
              (h.radAttr = Q),
              (h.stops = []),
              d(n, function (x) {
                0 === x[1].indexOf("rgba")
                  ? ((l = a.color(x[1])), (y = l.get("rgb")), (E = l.get("a")))
                  : ((y = x[1]), (E = 1));
                x = b
                  .createElement("stop")
                  .attr({
      ...
      applyTextOutline: function (x) {
        var f = this.element,
          ...
          c,
          r;
        -1 !== x.indexOf("contrast") &&
          (x = x.replace(/contrast/g, this.renderer.getContrast(f.style.fill)));
        x = x.split(" ");
        b = x[x.length - 1];
        if ((l = x[0]) && "none" !== l && a.svg) {
          ...
          l = l.replace(/(^[\d\.]+)(.*?)$/g, function (a, x, f) {
            return 2 * x + f;
          });
          for (r = x.length; r--; )
            (t = x[r]),
              "highcharts-text-outline" === t.getAttribute("class") &&
                w(x, f.removeChild(t));
          c = f.firstChild;
          d(x, function (a, x) {
            0 === x &&
              (a.setAttribute("x", f.getAttribute("x")),
              (x = f.getAttribute("y")),
              a.setAttribute("y", x || 0),
              null === x && f.setAttribute("y", 0));
            a = a.cloneNode(1);
            m(a, {
      ...
      attr: function (a, f, t, b) {
        ...
        "string" === typeof a &&
          ...
          ((x = a), (a = {}), (a[x] = f));
        "string" === typeof a
          ? (r = (this[a + "Getter"] || this._defaultGetter).call(this, a, l))
          : (I(
              a,
              function (x, f) {
                d = !1;
                ...
                this.symbolName &&
                  ...
                  (c || (this.symbolAttr(a), (c = !0)), (d = !0));
                !this.rotation ||
                  ("x" !== f && "y" !== f) ||
                  (this.doTransform = !0);
                d ||
                  ((p = this[f + "Setter"] || this._defaultSetter),
                  p.call(this, x, f, l),
                  this.shadows &&
                    /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(
                      f
                    ) &&
                    this.updateShadows(f, x, p));
              },
              this
            ),
            this.afterSetters());
      ...
      removeClass: function (a) {
        m(
          this.element,
          "class",
          (m(this.element, "class") || "").replace(a, "")
        );
        return this;
      },
      ...
      css: function (a) {
        ...
        p &&
          ...
          (l = this.textWidth =
            ...
            a.width &&
            "auto" !== a.width &&
            "text" === b.nodeName.toLowerCase() &&
            f(a.width)),
          (this.styles = a),
          l && !J && this.renderer.forExport && delete a.width,
          B && !J
            ? q(this.element, a)
            : ((d = function (a, x) {
          ...
          ? ((t.ontouchstart = function (a) {
            ...
            (t.onclick = function (a) {
              (-1 === P.navigator.userAgent.indexOf("Android") ||
                1100 < Date.now() - (x.touchEventFired || 0)) &&
                f.call(t, a);
            }))
          : (t["on" + a] = f);
        return this;
      ...
      align: function (a, f, t) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = f), !t || z(t))
          )
            (this.alignTo = x = t || "renderer"),
              w(l, this),
              l.push(this),
              (t = null);
        } else
      ...
      getBBox: function (a, f) {
        ...
        void 0 !== e &&
          ((E = e.toString()),
          -1 === E.indexOf("\x3c") && (E = E.replace(/[0-9]/g, "0")),
          (E += ["", f || 0, p, r && r.width, r && r.textOverflow].join()));
        E && !a && (x = Q[E]);
        if (!x) {
          ...
          t.isSVG &&
            ...
            f &&
              ((x.width =
                Math.abs(t * Math.sin(b)) + Math.abs(a * Math.cos(b))),
              (x.height =
                Math.abs(t * Math.cos(b)) + Math.abs(a * Math.sin(b)))));
          if (E && 0 < x.height) {
      ...
      add: function (a) {
        ...
        this.added = !0;
        if (!a || a.handleZ || this.zIndex) t = this.zIndexSetter();
      ...
      destroy: function () {
        ...
        a.clipPath &&
          b &&
          (d(b.querySelectorAll("[clip-path]"), function (x) {
            -1 <
              x
        ...
        a.safeRemoveChild(f);
        for (a.destroyShadows(); t && t.div && 0 === t.div.childNodes.length; )
      ...
      shadow: function (a, f, t) {
        ...
        if (!a) this.destroyShadows();
          ...
          d = L(a.width, 3);
          p = (a.opacity || 0.15) / d;
          e = this.parentInverted
            ? "(-1,-1)"
            : "(" + L(a.offsetX, 1) + ", " + L(a.offsetY, 1) + ")";
          for (b = 1; b <= d; b++)
            (l = c.cloneNode(0)),
              (r = 2 * d + 1 - 2 * b),
              m(l, {
              ...
              t &&
                (m(l, "height", Math.max(m(l, "height") - r, 0)),
                (l.cutHeight = r)),
              f ? f.element.appendChild(l) : c.parentNode.insertBefore(l, c),
              x.push(l);
          this.shadows = x;
        }
        return this;
      ...
      titleSetter: function (a) {
        ...
        f ||
          ((f = n.createElementNS(this.SVG_NS, "title")),
          this.element.appendChild(f));
        f.firstChild && f.removeChild(f.firstChild);
        f.appendChild(
          n.createTextNode(String(L(a), "").replace(/<[^>]*>/g, ""))
        );
      },
      ...
      fillSetter: function (a, f, t) {
        "string" === typeof a
          ? t.setAttribute(f, a)
          : a && this.colorGradient(a, f, t);
      },
      visibilitySetter: function (a, f, t) {
      ...
      zIndexSetter: function (a, t) {
        ...
        var p;
        u(a) &&
          ((r.zIndex = a), (a = +a), this[t] === a && (c = !1), (this[t] = a));
        if (c) {
          (a = this.zIndex) && b && (b.handleZ = !0);
          t = l.childNodes;
          for (p = 0; p < t.length && !d; p++)
            (b = t[p]),
              (c = b.zIndex),
              b !== r &&
                (f(c) > a ||
                  (!u(a) && u(c)) ||
                  (0 > a && !u(c) && l !== x.box)) &&
                (l.insertBefore(r, b), (d = !0));
          d || l.appendChild(r);
        }
        return d;
      },
      _defaultSetter: function (a, f, t) {
        t.setAttribute(f, a);
      },
    });
    C.prototype.yGetter = C.prototype.xGetter;
    C.prototype.translateXSetter =
      C.prototype.translateYSetter =
      C.prototype.rotationSetter =
      C.prototype.verticalAlignSetter =
      C.prototype.scaleXSetter =
      C.prototype.scaleYSetter =
        function (a, f) {
          this[f] = a;
          this.doTransform = !0;
        };
    C.prototype["stroke-widthSetter"] = C.prototype.strokeSetter = function (
      a,
      f,
      t
    ) {
      ...
      this.stroke && this["stroke-width"]
        ? (C.prototype.fillSetter.call(this, this.stroke, "stroke", t),
          t.setAttribute("stroke-width", this["stroke-width"]),
          (this.hasStroke = !0))
        : "stroke-width" === f &&
          0 === a &&
          this.hasStroke &&
          (t.removeAttribute("stroke"), (this.hasStroke = !1));
    };
    ...
    c(A.prototype, {
      ...
      init: function (a, f, t, b, c, r) {
        ...
        this.alignedObjects = [];
        this.url =
          (l || M) && n.getElementsByTagName("base").length
            ? P.location.href
                .replace(/#.*?$/, "")
                .replace(/<[^>]*>/g, "")
                .replace(/([\('\)])/g, "\\$1")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            n.createTextNode("Created with Highcharts 5.0.12")
          );
        ...
        l &&
          ...
          f(),
          (this.unSubPixelFix = G(P, "resize", f)));
      },
      getStyle: function (a) {
        return (this.style = c(
          {
      ...
      getSpanWidth: function (a, f) {
        ...
        !J &&
          this.forExport &&
          (t = this.measureSpanWidth(f.firstChild.data, a.styles));
        return t;
      },
        ...
        if (l) {
          for (; r <= d; )
            (c = Math.ceil((r + d) / 2)),
              (x = t.substring(0, c) + "\u2026"),
              p(x),
              (x = this.getSpanWidth(a, f)),
              r === d ? (r = d + 1) : x > b ? (d = c - 1) : (r = c);
          0 === d && p("");
        }
        return l;
      },
      buildText: function (a) {
        var t = a.element,
          ...
          M = function (a) {
            var b;
            b = /(px|em)$/.test(a && a.style.fontSize)
              ? a.style.fontSize
              : u || x.style.fontSize || 12;
            return I
              ? f(I)
              : x.fontMetrics(b, a.getAttribute("style") ? a : t).h;
          };
        ...
        if (R !== a.textCache) {
          ...
          r || z || D || g || -1 !== c.indexOf(" ")
            ? ((e = /<.*class="([^"]+)".*>/),
                    ...
                    if (" " !== f) {
                      ...
                      if (g) {
                        ...
                        var z = [],
                          ...
                          R = a.rotation;
                        for (
                          D && (y = x.applyEllipsis(a, p, f, g));
                          !D && B && (d.length || z.length);

                        )
                          (a.rotation = 0),
                            (Q = x.getSpanWidth(a, p)),
                            (f = Q > g),
                            void 0 === y && (y = f),
                            f && 1 !== d.length
              ...
              B && B.removeChild(t),
              z && a.applyTextOutline && a.applyTextOutline(z))
            : t.appendChild(
                n.createTextNode(
      ...
      button: function (a, f, t, b, l, r, d, e, h) {
        ...
        J = e.style;
        delete e.style;
        G(x.element, B ? "mouseover" : "mouseenter", function () {
          3 !== n && x.setState(1);
        });
        ...
        x.attr(l).css(c({ cursor: "default" }, E));
      ...
      circle: function (a, f, t) {
        ...
        f.xSetter = f.ySetter = function (a, f, t) {
      ...
      rect: function (a, f, t, b, l, c) {
        ...
        a = r(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: f, width: Math.max(t, 0), height: Math.max(b, 0) };
        void 0 !== c && ((a.strokeWidth = c), (a = x.crisp(a)));
        a.fill = "none";
        l && (a.r = l);
        x.rSetter = function (a, f, t) {
          m(t, { rx: a, ry: a });
        };
        return x.attr(a);
      },
      ...
      image: function (a, f, t, b, l) {
        ...
        x.element.setAttributeNS
          ? x.element.setAttributeNS("http://www.w3.org/1999/xlink", "href", a)
          : x.element.setAttribute("hc-svg-href", a);
        return x;
      },
      symbol: function (a, f, t, b, l, r) {
        var x = this,
          p,
          e = /^url\((.*?)\)$/,
          h = e.test(a),
          ...
          B =
            u(f) &&
            y &&
            y.call(this.symbols, Math.round(f), Math.round(t), b, l, r),
          w,
          J;
        y
          ? ((p = this.path(B)),
            p.attr("fill", "none"),
            c(p, { symbolName: E, x: f, y: t, width: b, height: l }),
            r && c(p, r))
          : h &&
            ((w = a.match(e)[1]),
            (p = this.image(w)),
            (p.imgwidth = L(O[w] && O[w].width, r && r.width)),
            (p.imgheight = L(O[w] && O[w].height, r && r.height)),
            (J = function () {
            ...
            d(["width", "height"], function (a) {
              p[a + "Setter"] = function (a, f) {
                ...
                this[f] = a;
                u(b) &&
                  (this.element && this.element.setAttribute(f, b),
                  this.alignByTranslate ||
                    ((t[l] = ((this[f] || 0) - b) / 2), this.attr(t)));
              };
            }),
            u(f) && p.attr({ x: f, y: t }),
            (p.isImg = !0),
      ...
      symbols: {
        circle: function (a, f, t, b) {
          return this.arc(a + t / 2, f + b / 2, t / 2, b / 2, {
            start: 0,
            end: 2 * Math.PI,
            open: !1,
          });
        ...
        callout: function (a, f, t, b, l) {
          ...
          p && p > t
            ...
            : p && 0 > p
            ? l > f + r && l < f + b - r
              ? d.splice(33, 3, "L", a, l + 6, a - 6, l, a, l - 6, a, f + c)
              : d.splice(33, 3, "L", a, b / 2, p, l, a, b / 2, a, f + c)
            : l && l > b && p > a + r && p < a + t - r
            ? d.splice(
                23,
                3,
            ...
            : l &&
              ...
              p > a + r &&
              p < a + t - r &&
              d.splice(3, 3, "L", p - 6, f, p, f - 6, p + 6, f, t - c, f);
          return d;
        },
      },
      ...
      fontMetrics: function (a, t) {
        a =
          a ||
          (t && t.style && t.style.fontSize) ||
          (this.style && this.style.fontSize);
        a = /px/.test(a)
          ? f(a)
          : /em/.test(a)
          ? parseFloat(a) * (t ? this.fontMetrics(null, t.parentNode).f : 16)
          : 12;
        t = 24 > a ? a + 3 : Math.round(1.2 * a);
        return { h: t, b: Math.round(0.8 * t), f: a };
      },
      ...
      label: function (f, b, l, r, e, h, n, E, y) {
        var x = this,
        ...
        U = function () {
          var a = w.element.style,
            f = {};
          g =
            (void 0 === q || void 0 === k || H) && u(w.textStr) && w.getBBox();
          B.width = (q || g.width || 0) + 2 * z + D;
          B.height = (k || g.height || 0) + 2 * z;
          M = z + x.fontMetrics(a && a.fontSize, w).b;
          Q &&
            (J ||
              ((B.box = J = x.symbols[r] || L ? x.symbol(r) : x.rect()),
              J.addClass(
                ("button" === y ? "" : "highcharts-label-box") +
                  (y ? " highcharts-" + y + "-box" : "")
              ),
              J.add(B),
              (a = V()),
              (f.x = a),
              (f.y = (E ? -M : 0) + a)),
            (f.width = Math.round(B.width)),
            (f.height = Math.round(B.height)),
            J.attr(c(f, v)),
            (v = {}));
        };
        O = function () {
          ...
          u(q) &&
            g &&
            ("center" === H || "right" === H) &&
            (a += { center: 0.5, right: 1 }[H] * (q - g.width));
          if (a !== w.x || f !== w.y)
            w.attr("x", a), void 0 !== f && w.attr("y", f);
          w.x = a;
          w.y = f;
        };
        P = function (a, f) {
  ...
  (function (a) {
    ...
    g(a.SVGElement.prototype, {
      ...
      htmlUpdateTransform: function () {
        if (this.added) {
          ...
          if ("SPAN" === c.tagName) {
            ...
            p !== this.cTT &&
              ((B = a.fontMetrics(c.style.fontSize).b),
              F(r) && this.setSpanRotation(r, l, B),
              G(c, {
                width: "",
                whiteSpace: q || "nowrap",
              }),
              ...
              this.getSpanCorrection(c.offsetWidth, B, l, r, g));
            G(c, {
      ...
      setSpanRotation: function (a, c, h) {
        ...
        b[d + (k ? "Origin" : "-origin")] = b.transformOrigin =
          100 * c + "% " + h + "px";
        G(this.element, b);
      },
    ...
    a.svg ||
      ((A = {
        ...
        init: function (a, b) {
          ...
          b &&
            ((l = d || "span" === b || "img" === b ? l.join("") : a.prepVML(l)),
            (this.element = G(l)));
          this.renderer = a;
        },
        add: function (a) {
        ...
        getSpanCorrection: function (a, b, c, d, e) {
          ...
          e &&
            "left" !== e &&
            ((this.xCorr -= a * c * (0 > l ? -1 : 1)),
            d && (this.yCorr -= h * c * (0 > r ? -1 : 1)),
            F(this.element, { textAlign: e }));
        },
        pathToVML: function (a) {
          for (var b = a.length, l = []; b--; )
            n(a[b])
              ? (l[b] = Math.round(10 * a[b]) - 5)
              : "Z" === a[b]
              ? (l[b] = "x")
              : ((l[b] = a[b]),
                !a.isArc ||
                  ("wa" !== a[b] && "at" !== a[b]) ||
                  (l[b + 5] === l[b + 7] &&
                    (l[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1),
                  l[b + 6] === l[b + 8] &&
                    (l[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1)));
          return l.join(" ") || "x";
        },
        clip: function (a) {
          var b = this,
        ...
        shadow: function (a, c, d) {
          ...
          if (a) {
            ...
            for (r = 1; 3 >= r; r++)
              (y = 2 * g + 1 - 2 * r),
                d && (J = this.cutOffPath(t.value, y + 0.5)),
                (f = [
                ...
                (h = G(e.prepVML(f), null, {
                  left: b(n.left) + w(a.offsetX, 1),
                  top: b(n.top) + w(a.offsetY, 1),
                })),
                d && (h.cutOff = y + 1),
                (f = [
                  '\x3cstroke color\x3d"',
                ...
                G(e.prepVML(f), null, null, h),
                c ? c.element.appendChild(h) : p.parentNode.insertBefore(h, p),
                l.push(h);
            this.shadows = l;
          }
          return this;
        ...
        dashstyleSetter: function (a, b, c) {
          (c.getElementsByTagName("stroke")[0] ||
            G(this.renderer.prepVML(["\x3cstroke/\x3e"]), null, null, c))[b] =
            a || "solid";
          this[b] = a;
        },
      ...
      (A = {
        ...
        color: function (b, c, d, e) {
          ...
          if (n) {
            ...
            var k,
              ...
              u = function () {
                h = [
                  '\x3cfill colors\x3d"' + m.join(",") + '" opacity\x3d"',
                  B,
                  '" o:opacity2\x3d"',
                  q,
                  '" type\x3d"',
            ...
            v(b, function (f, b) {
              r.test(f[1])
                ? ((p = a.color(f[1])), (t = p.get("rgb")), (y = p.get("a")))
                : ((t = f[1]), (y = 1));
              m.push(100 * f[0] + "% " + t);
              b ? ((B = y), (x = t)) : ((q = y), (D = t));
            });
            if ("fill" === d)
              if ("gradient" === n)
                (d = w.x1 || w[0] || 0),
                  ...
                  (z =
                    'angle\x3d"' +
                    (90 - (180 * Math.atan((w - b) / (g - d))) / Math.PI) +
                    '"'),
                  u();
              else {
                var f = w.r,
                  ...
                  f = function () {
                    T &&
                      ((K = e.getBBox()),
                      (C += (T[0] - K.x) / K.width - 0.5),
                      (F += (T[1] - K.y) / K.height - 0.5),
                      (H *= T[2] / K.width),
                      (A *= T[2] / K.height));
                    z =
                      'src\x3d"' +
            ...
            r.test(b) && "IMG" !== c.tagName
              ? ((p = a.color(b)),
                e[d + "-opacitySetter"](p.get("a"), d, c),
                (f = p.get("rgb")))
              : ((f = c.getElementsByTagName(d)),
        ...
        createElement: function (a) {
          return "rect" === a
            ? this.symbol(a)
            : D.prototype.createElement.call(this, a);
        },
        invertChild: function (a, c) {
          ...
          F(a, {
            flip: "x",
            left: b(c.width) - (l ? b(l.top) : 1),
            top: b(c.height) - (l ? b(l.left) : 1),
            rotation: -90,
          });
          v(a.childNodes, function (b) {
            d.invertChild(b, a);
          });
        },
        symbols: {
          ...
          rect: function (a, b, c, d, e) {
            return D.prototype.symbols[m(e) && e.r ? "callout" : "square"].call(
              0,
              a,
              b,
              c,
  ...
  (function (a) {
    ...
    function A() {
      ...
      u.hcMakeTime = function (a, c, e, b, n, g) {
        var d;
        h
          ? ((d = u.UTC.apply(0, arguments)), (d += m(d)))
          : (d = new u(a, c, k(e, 1), k(b, 0), k(n, 0), k(g, 0)).getTime());
        return d;
      };
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        a.isDatetimeAxis &&
          c &&
          (y = k.dateTimeLabelFormats[c.higherRanks[n] || c.unitName]);
        this.isFirst = w;
        this.isLast = b;
      ...
      handleOverflow: function (a) {
        var q = this.axis,
          ...
          d = this.label,
          c = this.rotation,
          w = { left: 0, center: 0.5, right: 1 }[q.labelAlign],
          b = d.getBBox().width,
          y = q.getSlotWidth(),
          D = y,
          H = 1,
        ...
        if (c)
          0 > c && m - w * b < n
            ? (l = Math.round(m / Math.cos(c * k) - n))
            : 0 < c &&
              m + w * b > e &&
              (l = Math.round((h - m) / Math.cos(c * k)));
        else if (
          ((h = m + (1 - w) * b),
          m - w * b < n
            ? (D = a.x + D * (1 - w) - n)
          ...
          D < y &&
            "center" === q.labelAlign &&
            (a.x += H * (y - D - w * (y - Math.min(b, D)))),
          b > D || (q.autoRotation && (d.styles || {}).width))
        )
          l = D;
        l &&
          ((B.width = l),
          (q.options.labels.style || {}).textOverflow ||
      ...
      getPosition: function (a, g, k, h) {
        ...
        return {
          x: a
            ? e.translate(g + k, null, null, h) + e.transB
            : e.left +
              e.offset +
              (e.opposite
                ? ((h && n.oldChartWidth) || n.chartWidth) - e.right - e.left
                : 0),
          y: a
            ? d - e.bottom + e.offset - (e.opposite ? e.height : 0)
            : d - e.translate(g + k, null, null, h) - e.transB,
        };
      },
        ...
        A(l) ||
          (l =
            0 === w.side
              ...
              : 2 === w.side
              ? q.y + 8
              : Math.cos(m.rotation * k) * (q.y - m.getBBox(!1, 0).height / 2));
      ...
      renderGridLine: function (a, g, k) {
        ...
        if (
          !a &&
          n &&
          (a = h.getPlotLinePath(c + b, n.strokeWidth() * k, a, !0))
        )
          n[this.isNew ? "attr" : "animate"]({ d: a, opacity: g });
      },
          ...
          y &&
            ((this.mark = b =
              n
                ...
                .add(h.axisGroup)),
            b.attr({ stroke: e, "stroke-width": q })),
          b[y ? "attr" : "animate"]({
            d: this.getMarkPath(D, a, w[0], b.strokeWidth() * m, h.horiz, n),
            opacity: k,
          }));
      },
      renderLabel: function (a, k, m, h) {
        ...
        c &&
          F(q) &&
          ((c.xy = a = this.getLabelPosition(q, a, c, n, w, y, h, b)),
          (this.isFirst && !this.isLast && !g(d.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !g(d.showLastLabel, 1))
            ? (D = !1)
            : !n ||
              e.isRadial ||
              w.step ||
          ...
          D && F(a.y)
            ? ((a.opacity = m),
              c[this.isNewLabel ? "attr" : "animate"](a),
              (this.isNewLabel = !1))
  ...
  var S = (function (a) {
    ...
    a.extend(L.prototype, {
      ...
      init: function (a, t) {
        ...
        c.side =
          t.side || (c.horiz ? (c.opposite ? 0 : 2) : c.opposite ? 1 : 3);
        c.setOptions(t);
        var d = this.options,
          e = d.type;
        ...
        c.crosshair = z(
          d.crosshair,
          p(a.options.tooltip.crosshairs)[f ? 0 : 1],
          !1
        );
        t = c.options.events;
        -1 === b(c, a.axes) &&
          (f ? a.axes.splice(a.xAxis.length, 0, c) : a.axes.push(c),
          a[c.coll].push(c));
        c.series = c.series || [];
        a.inverted &&
          !c.isZAxis &&
          ...
          for (; r-- && void 0 === x; )
            (c = Math.pow(e, r + 1)),
              f >= c &&
                ...
                null !== l[r] &&
                0 !== b &&
                (x = a.numberFormat(b / c, -1) + l[r]);
        void 0 === x &&
          (x =
            1e4 <= Math.abs(b)
              ? a.numberFormat(b, -1)
              : a.numberFormat(b, -1, void 0, ""));
        return x;
      },
        ...
        h(a.series, function (f) {
          if (f.visible || !b.options.chart.ignoreHiddenSeries) {
            ...
            if (a.isXAxis)
              (c = f.xData),
                c.length &&
                  ...
                  D(f) ||
                    ...
                    (f = F(c))),
                  (a.dataMin = Math.min(z(a.dataMin, c[0]), f)),
                  (a.dataMax = Math.max(z(a.dataMax, c[0]), G(c))));
            else if (
              (f.getExtremes(),
              (d = f.dataMax),
              (f = f.dataMin),
              q(f) &&
                q(d) &&
                ((a.dataMin = Math.min(z(a.dataMin, f), f)),
                (a.dataMax = Math.max(z(a.dataMax, d), d))),
              q(t) && (a.threshold = t),
      ...
      translate: function (a, b, c, d, p, e) {
        ...
        r || (r = f.transA);
        c && ((t *= -1), (l = f.len));
        f.reversed && ((t *= -1), (l -= t * (f.sector || f.len)));
        b
          ? ((a = (a * t + l - h) / r + d), p && (a = f.lin2val(a)))
          : (p && (a = f.val2lin(a)),
            (a = t * (a - d) * r + l + t * h + (D(e) ? r * e : 0)));
        return a;
      },
      toPixels: function (a, b) {
        return (
          this.translate(a, !1, !this.horiz, null, !0) + (b ? 0 : this.pos)
        );
      },
      ...
      getPlotLinePath: function (a, b, c, d, p) {
        ...
        D(p)
          ? this.horiz
            ? ((l = e),
              (r = h - this.bottom),
              (a = c = g(a, t, t + this.width)))
            : ((a = t),
              (c = n - this.right),
              (l = r = g(l, e, e + this.height)))
          : (w = !0);
        return w && !d
          ? null
          : f.renderer.crispLine(["M", a, l, "L", c, r], b || 1);
      },
      getLinearTickPositions: function (a, b, c) {
        var f,
          t = g(Math.floor(b / a) * a);
        c = g(Math.ceil(c / a) * a);
        var d = [];
      ...
      getMinorTickPositions: function () {
        ...
        if (x && x / d < a.len / 3)
          if (a.isLog)
            h(this.paddedTicks, function (b, f, c) {
              f &&
                p.push.apply(p, a.getLogTickPositions(d, c[f - 1], c[f], !0));
            });
          else if (a.isDatetimeAxis && "auto" === b.minorTickInterval)
            p = p.concat(
              a.getTimeTicks(
                a.normalizeTimeTickInterval(d),
                l,
                e,
                b.startOfWeek
              )
      ...
      adjustForMinRange: function () {
        ...
        c - b < this.minRange &&
          ((p = this.dataMax - this.dataMin >= this.minRange),
          (w = this.minRange),
          (d = (w - c + b) / 2),
          (d = [b - d, z(a.min, b - d)]),
          ...
          (b = G(d)),
          (c = [b + w, z(a.max, b + w)]),
          p && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (c = F(c)),
          c - b < w && ((d[0] = c - w), (d[1] = z(a.min, c - w)), (b = G(d))));
        this.min = b;
        this.max = c;
      },
      getClosest: function () {
        ...
        0 < this.names.length &&
          ...
          h(this.series || [], function (b) {
            ...
            h(b.points, function (f, c) {
              ...
              f.options &&
                ((t = a.nameToX(f)),
                void 0 !== t && t !== f.x && ((f.x = t), (b.xData[c] = t)));
            });
          }));
      },
      setAxisTranslation: function (a) {
        ...
        if (w || r || c)
          (d = b.getClosest()),
            l
              ? ((p = l.minPointOffset), (e = l.pointRangePadding))
              : h(b.series, function (a) {
                  var f = r
                    ? 1
                    : w
                    ? z(a.options.pointRange, d, 0)
                    : b.axisPointRange || 0;
                  a = a.options.pointPlacement;
                  c = Math.max(c, f);
                  b.single ||
                    ((p = Math.max(p, H(a) ? 0 : f / 2)),
                    (e = Math.max(e, "on" === a ? 0 : f)));
                }),
            (l = b.ordinalSlope && d ? b.ordinalSlope / d : 1),
            (b.minPointOffset = p *= l),
            (b.pointRangePadding = e *= l),
            (b.pointRange = Math.min(c, f)),
            w && (b.closestPointRange = d);
        a && (b.oldTransA = n);
        b.translationSlope =
          b.transA =
          n =
            b.options.staticScale || b.len / (f + e || 1);
      ...
      setTickInterval: function (b) {
        ...
        A = z(f.userMax, p.max);
        w
          ? ((f.linkedParent = d[f.coll][p.linkedTo]),
            (d = f.linkedParent.getExtremes()),
            (f.min = z(d.min, d.dataMin)),
            (f.max = z(d.max, d.dataMax)),
            p.type !== f.linkedParent.options.type && a.error(11, 1))
          : (!u &&
              q(H) &&
              (f.dataMin >= H
                ? ((L = H), (E = 0))
                : f.dataMax <= H && ((v = H), (y = 0))),
            (f.min = z(M, L, f.dataMin)),
            (f.max = z(A, v, f.dataMax)));
        e &&
          (f.positiveValuesOnly &&
            !b &&
            0 >= Math.min(f.min, z(f.dataMin, f.min)) &&
            a.error(10, 1),
          (f.min = g(l(f.min), 15)),
          (f.max = g(l(f.max), 15)));
        f.range &&
          q(f.max) &&
          ((f.userMin = f.min = M = Math.max(f.min, f.minFromRange())),
          (f.userMax = A = f.max),
          (f.range = null));
        n(f, "foundExtremes");
        f.beforePadding && f.beforePadding();
        f.adjustForMinRange();
        !(m || f.axisPointRange || f.usePercentage || w) &&
          q(f.min) &&
          q(f.max) &&
          (l = f.max - f.min) &&
          (!q(M) && E && (f.min -= l * E), !q(A) && y && (f.max += l * y));
        ...
        u &&
          q(f.dataMin) &&
          ((H = H || 0),
          !q(M) && f.min < H && f.dataMin >= H
            ? (f.min = H)
            : !q(A) && f.max > H && f.dataMax <= H && (f.max = H));
        f.tickInterval =
          f.min === f.max || void 0 === f.min || void 0 === f.max
            ? 1
            : w && !k && I === f.linkedParent.options.tickPixelInterval
            ? (k = f.linkedParent.tickInterval)
            : z(
                k,
                this.tickAmount
                  ? (f.max - f.min) / Math.max(this.tickAmount - 1, 1)
                  : void 0,
                m ? 1 : ((f.max - f.min) * I) / Math.max(f.len, I)
              );
        x &&
          !b &&
          h(f.series, function (a) {
            a.processData(f.min !== f.oldMin || f.max !== f.oldMax);
          });
        f.setAxisTranslation(!0);
        f.beforeSetTickPositions && f.beforeSetTickPositions();
        f.postProcessTickInterval &&
          (f.tickInterval = f.postProcessTickInterval(f.tickInterval));
        f.pointRange &&
          !k &&
          (f.tickInterval = Math.max(f.pointRange, f.tickInterval));
      ...
      alignToOthers: function () {
        ...
        !1 === this.chart.options.chart.alignTicks ||
          !1 === c.alignTicks ||
          this.isLog ||
          h(this.chart[this.coll], function (f) {
            var c = f.options,
      ...
      setAxisSize: function () {
        ...
        c.test(e) &&
          (e = Math.round((parseFloat(e) / 100) * a.plotHeight + a.plotTop));
        this.left = b;
        this.top = e;
        this.width = p;
        this.height = l;
      ...
      unsquish: function () {
        var a = this.options.labels,
          ...
          d = c,
          p =
            this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c),
          l,
          e = a.rotation,
          r = this.labelMetrics(),
          n,
        ...
        b
          ? (g =
              ...
              (q(e)
                ? [e]
                : p < z(a.autoRotationLimit, 80) && a.autoRotation)) &&
            h(g, function (a) {
              var b;
              if (a === e || (a && -90 <= a && 90 >= a))
                (n = y(Math.abs(r.h / Math.sin(v * a)))),
                  (b = n + Math.abs(a / 360)),
                  b < w && ((w = b), (l = a), (d = n));
            })
          : a.step || (d = y(r.h));
      ...
      getSlotWidth: function () {
        ...
        return (
          ...
          (!b && ((p && p - a.spacing[3]) || 0.33 * a.chartWidth))
        );
      },
      renderUnsquish: function () {
        ...
        if (this.autoRotation)
          E > x && E > w.h
            ? (n.rotation = this.labelRotation)
            : (this.labelRotation = 0);
        else if (r && ((y = { width: x + "px" }), !g))
          for (y.textOverflow = "clip", k = c.length; !e && k--; )
            if (((I = c[k]), (x = d[I].label)))
              x.styles && "ellipsis" === x.styles.textOverflow
                ? x.css({ textOverflow: "clip" })
                : d[I].labelLength > r && x.css({ width: r + "px" }),
                x.getBBox().height > this.len / c.length - (w.h - w.f) &&
                  (x.specCss = { textOverflow: "ellipsis" });
        n.rotation &&
          ((y = {
            width:
              (E > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight) +
              "px",
          }),
          g || (y.textOverflow = "ellipsis"));
        if (
          (this.labelAlign = p.align || this.autoLabelAlign(this.labelRotation))
        )
          n.align = this.labelAlign;
        h(c, function (a) {
          var b = (a = d[a]) && a.label;
          b &&
            (b.attr(n),
            y && b.css(l(y, b.specCss)),
            delete b.specCss,
      ...
      hasData: function () {
        return (
          ...
          (q(this.min) && q(this.max) && !!this.tickPositions)
        );
      },
      addTitle: function (a) {
        ...
        this.axisTitle ||
          ...
          (this.axisTitle = b
            ...
            .attr({ zIndex: 7, rotation: d.rotation || 0, align: p })
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ((a.gridGroup = c
            ...
            .addClass(
              "highcharts-" + this.coll.toLowerCase() + "-grid " + (u || "")
            )
            .add(L)),
          (a.axisGroup = c
            .g("axis")
          ...
          (a.labelGroup = c
            .g("axis-labels")
            .attr({ zIndex: D.zIndex || 7 })
            .addClass(
              "highcharts-" + a.coll.toLowerCase() + "-labels " + (u || "")
            )
            .add(L)));
        w || a.isLinked
          ? (h(p, function (b, c) {
        ...
        I &&
          ...
          g &&
            !1 !== I.reserveSpace &&
            ((a.titleOffset = y =
              a.axisTitle.getBBox()[e ? "height" : "width"]),
            (E = I.offset),
            (k = q(E) ? 0 : z(I.margin, e ? 5 : 10))));
        a.renderLine();
        a.offset = H * z(d.offset, B[x]);
        a.tickRotCorr = a.tickRotCorr || { x: 0, y: 0 };
        c = 0 === x ? -a.labelMetrics().h : 2 === x ? a.tickRotCorr.y : 0;
        k = Math.abs(m) + k;
        m && (k = k - c + H * (e ? z(D.y, a.tickRotCorr.y + 8 * H) : D.x));
        a.axisTitleMargin = z(E, k);
        B[x] = Math.max(
          B[x],
          a.axisTitleMargin + y + H * a.offset,
          k,
          w && p.length && v ? v[0] + H * a.offset : 0
        );
      ...
      getTitlePosition: function () {
        var a = this.horiz,
          ...
          h = p.x || 0,
          n = p.y || 0,
          w = this.chart.renderer.fontMetrics(
            p.style && p.style.fontSize,
            this.axisTitle
          ).f,
          d = {
            low: l + (a ? 0 : d),
          ...
          b =
            (a ? c + this.height : b) +
            (a ? 1 : -1) * (e ? -1 : 1) * this.axisTitleMargin +
            (2 === this.side ? w : 0);
        return {
          x: a ? d + h : b + (e ? this.width : 0) + r + h,
          y: a ? b + n - (e ? this.height : 0) + r : d + n,
        };
      },
      ...
      renderTick: function (a, b) {
        var c = this.isLinked,
          f = this.ticks,
          d = this.chart.hasRendered && D(this.oldMin);
        if (!c || (a >= this.min && a <= this.max))
          f[a] || (f[a] = new I(this, a)),
            d && f[a].isNew && f[a].render(b, !0, 0.1),
            f[a].render(b);
      },
      render: function () {
        var b = this,
        ...
        if (b.hasData() || e)
          b.minorTickInterval &&
            !b.categories &&
            h(b.getMinorTickPositions(), function (a) {
              b.renderMinorTick(a);
            }),
            n.length &&
              (h(n, function (a, c) {
              ...
              q &&
                (0 === b.min || b.single) &&
                (w[-1] || (w[-1] = new I(b, -1, null, !0)), w[-1].render(-1))),
            m &&
              h(n, function (f, d) {
                ...
                0 === d % 2 &&
                  f < b.max &&
                  L <= b.max + (c.polar ? -q : q) &&
                  (y[f] || (y[f] = new a.PlotLineOrBand(b)),
                  (u = f + q),
                  (y[f].options = {
                    from: p ? l(u) : u,
                    to: p ? l(L) : L,
            ...
            b._addedPlotLB ||
              (h((d.plotLines || []).concat(d.plotBands || []), function (a) {
        ...
        z &&
          (z[z.isPlaced ? "animate" : "attr"]({
            d: this.getLinePath(z.strokeWidth()),
          }),
          (z.isPlaced = !0),
          z[B ? "show" : "hide"](!0));
        x &&
          ...
          D(d.y)
            ? (x[x.isNew ? "attr" : "animate"](d), (x.isNew = !1))
      ...
      redraw: function () {
        this.visible &&
          (this.render(),
          h(this.plotLinesAndBands, function (a) {
            a.render();
          }));
        h(this.series, function (a) {
          a.isDirty = !0;
      ...
      drawCrosshair: function (a, b) {
        ...
        this.crosshair && !1 !== (q(b) || !d)
          ? (d
              ? q(b) && (p = this.isXAxis ? b.plotX : this.len - b.plotY)
              : (p =
                  a &&
                  (this.horiz
                    ? a.chartX - this.pos
            ...
            q(p) &&
              (c =
                this.getPlotLinePath(
                  b && (this.isXAxis ? b.x : z(b.stackY, b.y)),
                  null,
                  null,
                  null,
                  p
                ...
                l ||
                  ((this.cross = l =
                    this.chart.renderer
                      ...
                      .attr({ zIndex: z(f.zIndex, 2) })
                      .add()),
                  l.attr({
                    stroke:
                      f.color ||
                      (b ? m("#ccd6eb").setOpacity(0.25).get() : "#cccccc"),
                    "stroke-width": z(f.width, 1),
                  }),
                  f.dashStyle && l.attr({ dashstyle: f.dashStyle })),
                l.show().attr({ d: c }),
                b && !f.width && l.attr({ "stroke-width": this.transA }),
                (this.cross.e = a))
              : this.hideCrosshair())
          : this.hideCrosshair();
      },
  ...
  (function (a) {
    ...
    C.prototype.getTimeTicks = function (a, d, c, w) {
      var b = [],
        ...
        u;
      if (m(d)) {
        l[A.hcSetMilliseconds](
          r >= e.second ? 0 : z * Math.floor(l.getMilliseconds() / z)
        );
        if (r >= e.second)
          l[A.hcSetSeconds](
            r >= e.minute ? 0 : z * Math.floor(l.getSeconds() / z)
          );
        if (r >= e.minute)
          l[A.hcSetMinutes](
            r >= e.hour ? 0 : z * Math.floor(l[A.hcGetMinutes]() / z)
          );
        if (r >= e.hour)
          l[A.hcSetHours](
            r >= e.day ? 0 : z * Math.floor(l[A.hcGetHours]() / z)
          );
        if (r >= e.day)
          l[A.hcSetDate](
            r >= e.month ? 1 : z * Math.floor(l[A.hcGetDate]() / z)
          );
        r >= e.month &&
          (l[A.hcSetMonth](
            r >= e.year ? 0 : z * Math.floor(l[A.hcGetMonth]() / z)
          ),
          (q = l[A.hcGetFullYear]()));
        if (r >= e.year) l[A.hcSetFullYear](q - (q % z));
        if (r === e.week)
          l[A.hcSetDate](l[A.hcGetDate]() - l[A.hcGetDay]() + h(w, 1));
        q = l[A.hcGetFullYear]();
        w = l[A.hcGetMonth]();
        var p = l[A.hcGetDate](),
          E = l[A.hcGetHours]();
        if (A.hcTimezoneOffset || A.hcGetTimezoneOffset)
          (u =
            (!D || !!A.hcGetTimezoneOffset) &&
            (c - d > 4 * e.month || v(d) !== v(c))),
            (l = l.getTime()),
            (l = new A(l + v(l)));
        D = l.getTime();
        for (d = 1; D < c; )
    ...
    C.prototype.normalizeTimeTickInterval = function (a, d) {
      ...
      for (
        ...
        (h = e[d[0]]),
        (b = d[1]),
        c[n + 1] && a <= (h * b[b.length - 1] + e[c[n + 1][0]]) / 2);
        n++
      );
      h === e.year && a < 5 * h && (b = [1, 2, 5]);
      a = u(a / h, b, "year" === d[0] ? Math.max(q(a / h), 1) : 1);
  ...
  (function (a) {
    ...
    C.prototype.getLogTickPositions = function (a, k, q, v) {
      ...
      if (0.5 <= a)
        (a = Math.round(a)), (d = this.getLinearTickPositions(a, k, q));
      else if (0.08 <= a)
        for (
          var h = Math.floor(k),
            c,
          ...
          for (w = g.length, c = 0; c < w && !D; c++)
            (b = n(e(h) * g[c])),
              b > k && (!v || y <= q) && void 0 !== y && d.push(y),
              y > q && (D = !0),
              (y = b);
      else
        (k = e(k)),
          (q = e(q)),
          (a = g[v ? "minorTickInterval" : "tickInterval"]),
          (a = m(
            "auto" === a ? null : a,
            this._minorAutoInterval,
            ((g.tickPixelInterval / (v ? 5 : 1)) * (q - k)) /
              ((v ? h / this.tickPositions.length : h) || 1)
          )),
          (a = F(a, null, A(a))),
          (d = G(this.getLinearTickPositions(a, k, q), n)),
  ...
  (function (a, C) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        ...
        m
          ? ((r = { stroke: z, "stroke-width": n.width }),
            n.dashStyle && (r.dashstyle = n.dashStyle))
          : k &&
            (z && (r.fill = z),
            n.borderWidth &&
              ((r.stroke = n.borderColor),
              (r["stroke-width"] = n.borderWidth)));
        E.zIndex = M;
        L += "-" + M;
        (z = h.plotLinesAndBandsGroups[L]) ||
          (h.plotLinesAndBandsGroups[L] = z =
            I.g("plot-" + L)
              .attr(E)
              .add());
        ...
        B && r && r.length
          ...
          : l &&
            (r
              ? (l.show(), l.animate({ d: r }))
              : (l.hide(), c && (g.label = c = c.destroy())));
        d &&
        F(d.text) &&
        r &&
        r.length &&
          ...
          ? ((d = q(
              {
                align: e && k && "center",
                x: e ? !k && 4 : 10,
                verticalAlign: !e && k && "middle",
                y: e ? (k ? 16 : 10) : k ? 6 : -4,
                rotation: e && !k && 90,
              },
              d
            )),
            this.renderLabel(d, r, k, M))
          : c && c.hide();
        return g;
      },
      renderLabel: function (a, h, e, n) {
        ...
        d ||
          ...
          (d.zIndex = n),
          (this.label = d = c.text(a.text, 0, 0, a.useHTML).attr(d).add()),
          d.css(a.style));
        n = [h[1], h[4], e ? h[6] : h[1]];
        h = [h[2], h[5], e ? h[7] : h[2]];
        e = G(n);
    ...
    a.extend(C.prototype, {
      getPlotBandPath: function (a, h) {
        ...
        n && e
          ? (a && ((n.flat = n.toString() === e.toString()), (c = 0)),
            n.push(
              d && e[4] === n[4] ? e[4] + c : e[4],
              d || e[5] !== n[5] ? e[5] : e[5] + c,
              d && e[1] === n[1] ? e[1] + c : e[1],
      ...
      addPlotBandOrLine: function (g, h) {
        var e = new a.PlotLineOrBand(this, g).render(),
          n = this.userOptions;
        e &&
          (h && ((n[h] = n[h] || []), n[h].push(g)),
          this.plotLinesAndBands.push(e));
        return e;
      },
      removePlotBandOrLine: function (a) {
        for (
          var h = this.plotLinesAndBands,
            e = this.options,
            n = this.userOptions,
            d = h.length;
          d--;
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      move: function (a, h, d, c) {
        var e = this,
          ...
          n =
            ...
            !e.isHidden &&
            (1 < Math.abs(a - b.x) || 1 < Math.abs(h - b.y)),
          g = e.followPointer || 1 < e.len;
        G(b, {
          x: n ? (2 * b.x + a) / 3 : a,
          y: n ? (b.y + h) / 2 : h,
          anchorX: g ? void 0 : n ? (2 * b.anchorX + d) / 3 : d,
          anchorY: g ? void 0 : n ? (b.anchorY + c) / 2 : c,
        });
        e.getLabel().attr(b);
        n &&
          (clearTimeout(this.tooltipTimeout),
      ...
      getAnchor: function (a, h) {
        ...
        this.followPointer &&
          h &&
          (void 0 === h.chartX && (h = c.pointer.normalize(h)),
          (d = [h.chartX - c.plotLeft, h.chartY - b]));
        d ||
          (A(a, function (a) {
            l = a.series.yAxis;
            q = a.series.xAxis;
            k += a.plotX + (!e && q ? q.left - n : 0);
            m +=
      ...
      getPosition: function (a, h, d) {
        var c = this.chart,
          ...
          z = function (a, c, d, f) {
            ...
            f < e || f > c - e
              ? (p = !1)
              : (b[a] = f < d / 2 ? 1 : f > c - d / 2 ? c - d - 2 : f - d / 2);
            return p;
          },
          v = function (a) {
            var b = k;
      ...
      refresh: function (a, h) {
        ...
        !1 === n
          ...
          : ((d = this.getLabel()),
            ...
            this.split
              ? this.renderSplit(n, a)
              : (c.style.width || d.css({ width: this.chart.spacingBox.width }),
                d.attr({ text: n && n.join ? n.join("") : n }),
                d
                  .removeClass(/highcharts-color-[\d]+/g)
                  .addClass(
                    "highcharts-color-" + q(b.colorIndex, l.colorIndex)
                  ),
                d.attr({
                  stroke: c.borderColor || b.color || l.color || "#666666",
                }),
                this.updatePosition({
                  plotX: h,
                  plotY: e,
      ...
      renderSplit: function (e, h) {
        ...
        A(e.slice(0, h.length + 1), function (a, e) {
          ...
          w ||
            (r.tt = w =
              b
                ...
                .addClass("highcharts-tooltip-box " + y)
                .attr({
                  padding: k.padding,
                  r: k.borderRadius,
          ...
          e.isHeader
            ? ((m = a.height),
              (p = Math.max(
                0,
                Math.min(e.plotX + g.plotLeft - p / 2, g.chartWidth - p)
              )))
            : (p = e.plotX + g.plotLeft - q(k.distance, 16) - p);
          0 > p && (n = !1);
          a =
            (e.series && e.series.yAxis && e.series.yAxis.pos) + (e.plotY || 0);
          a -= g.plotTop;
          c.push({
            target: e.isHeader ? g.plotHeight + m : a,
            rank: e.isHeader ? 1 : 0,
        ...
        A(c, function (a) {
          ...
          a.tt.attr({
            ...
            x: n || b.isHeader ? a.x : b.plotX + g.plotLeft + q(k.distance, 16),
            y: a.pos + g.plotTop,
      ...
      getDateFormat: function (a, g, d, c) {
        ...
        for (n in h) {
          ...
          if (k[n] && e.substr(k[n]) !== "01-01 00:00:00.000".substr(k[n]))
            break;
          "week" !== n && (m = n);
        }
        n && (b = c[n]);
      ...
      getXDateFormat: function (a, h, d) {
        ...
        return (
          (c ? this.getDateFormat(c, a.x, d.options.startOfWeek, h) : h.day) ||
          h.year
        );
      },
    ...
    a.Pointer.prototype = {
      init: function (a, d) {
        ...
        c &&
          ...
          (this.followTouchMove = e(d.tooltip.followTouchMove, !0)));
        this.setDOMEvents();
      },
      ...
      normalize: function (a, c) {
        ...
        void 0 === d.pageX
          ? ((b = Math.max(a.x, a.clientX - c.left)), (c = a.y))
          : ((b = d.pageX - c.left), (c = d.pageY - c.top));
      ...
      getKDPoints: function (a, c, d) {
        ...
        q(a, function (a) {
          ...
          a.visible &&
            !h &&
            e(a.options.enableMouseTracking, !0) &&
            (r = a.searchPoint(
              d,
              !l && 0 > a.options.findNearestPointBy.indexOf("y")
            )) &&
            r.series &&
            b.push(r);
        });
      ...
      getChartCoordinatesFromPoint: function (a, c) {
        ...
        if (d && b)
          return c
            ...
            : { chartX: a.clientX + d.pos, chartY: a.plotY + b.pos };
      },
      ...
      runPointActions: function (b, c) {
        ...
        c = this.getHoverData(
          ...
          r,
          d.series,
          !!c || (r && r.directTouch && this.isDirectTouch),
          l,
          b
        );
        var n,
        ...
        w = (l = l && g && !g.series.noSharedTooltip)
          ? c.hoverPoints
          : g
          ? [g]
          : [];
        if (g && (g !== d.hoverPoint || (h && h.isHidden))) {
          ...
          n &&
            ...
            !h.isHidden &&
            ((r = h.getAnchor([{}], b)),
            h.updatePosition({ plotX: r[0], plotY: r[1] }));
        this.unDocMouseMove ||
          (this.unDocMouseMove = C(k, "mousemove", function (b) {
            var c = G[a.hoverChartIndex];
            if (c) c.pointer.onDocumentMouseMove(b);
          }));
        q(d.axes, function (c) {
          e(c.crosshair.snap, !0)
            ? a.find(w, function (a) {
      ...
      scaleGroups: function (a, c) {
        ...
        q(b.series, function (e) {
          ...
          e.xAxis &&
            ...
            (e.group.attr(d),
            e.markerGroup &&
              (e.markerGroup.attr(d),
              e.markerGroup.clip(c ? b.clipRect : null)),
      ...
      drag: function (a) {
        ...
        (q && q.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(f - d, 2) + Math.pow(t - e, 2)
          )),
          10 < this.hasDragged &&
            ((m = b.isInsidePlot(f - n, t - w)),
            b.hasCartesianSeries &&
              (this.zoomX || this.zoomY) &&
              m &&
              !v &&
              !q &&
              (this.selectionMarker = q =
                b.renderer
                  .rect(n, w, h ? 1 : p, g ? 1 : k, 0)
                  .attr({
                    fill:
            ...
            q &&
              h &&
              ((d -= f),
              q.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + f })),
            q &&
              g &&
              ((d = e - t),
              q.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + t })),
            m && !q && c.panning && b.pan(a, c.panning)));
      },
      drop: function (a) {
        var b = this,
          c = this.chart,
        ...
        c &&
          (m(c.container, { cursor: c._cursor }),
      ...
      onContainerMouseMove: function (b) {
        ...
        (g(a.hoverChartIndex) &&
          G[a.hoverChartIndex] &&
          G[a.hoverChartIndex].mouseIsDown) ||
      ...
      onContainerClick: function (a) {
        ...
        b.cancelClick ||
          (c && this.inClass(a.target, "highcharts-tracker")
            ? (u(c.series, "click", v(a, { point: c })),
              b.hoverPoint && c.firePointEvent("click", a))
            : (v(a, this.getCoordinates(a)),
      ...
      destroy: function () {
        ...
        n(b.chart.container, "mouseleave", b.onContainerMouseLeave);
        a.chartCount ||
          (n(k, "mouseup", b.onDocumentMouseUp),
          n(k, "touchend", b.onDocumentTouchEnd));
  ...
  (function (a) {
    ...
    G(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, g, m, u, h, e, n, d) {
        ...
        g < M.min
          ? ((g = M.min), (t = !0))
          : g + l > M.max && ((g = M.max - l), (t = !0));
        t
          ? ((I -= 0.8 * (I - n[w][0])), p || (f -= 0.8 * (f - n[w][1])), m())
          : (n[w] = [I, f]);
        z || ((e[w] = B - v), (e[q] = l));
        e = z ? 1 / r : r;
        h[q] = l;
        h[w] = g;
        u[z ? (a ? "scaleY" : "scaleX") : "scale" + b] = r;
      ...
      pinch: function (a) {
        var k = this,
          ...
          b =
            1 === e &&
            ((k.inClass(a.target, "highcharts-tracker") && v.runTrackerClick) ||
              k.runChartClick),
          y = {};
        1 < e && (k.initiated = !0);
        ...
        "touchstart" === a.type
          ? (A(h, function (a, b) {
            ...
            (n.x = [u[0].chartX, u[1] && u[1].chartX]),
            (n.y = [u[0].chartY, u[1] && u[1].chartY]),
            A(v.axes, function (a) {
              if (a.zoomEnabled) {
            ...
            (k.res = !0))
          : k.followTouchMove && 1 === e
          ? this.runPointActions(k.normalize(a))
          : u.length &&
            (c ||
              (k.selectionMarker = c = G({ destroy: m, touch: !0 }, v.plotBox)),
            k.pinchTranslate(u, h, w, c, y, n),
            (k.hasPinched = d),
            k.scaleGroups(w, y),
      ...
      touch: function (k, m) {
        ...
        1 === k.touches.length
          ? ((k = this.normalize(k)),
            (h = q.isInsidePlot(k.chartX - q.plotLeft, k.chartY - q.plotTop)) &&
            !q.openMenu
              ? (m && this.runPointActions(k),
                "touchmove" === k.type &&
                  ((m = this.pinchDown),
                  (u = m[0]
                    ? 4 <=
                      Math.sqrt(
                        Math.pow(m[0].chartX - k.chartX, 2) +
                          Math.pow(m[0].chartY - k.chartY, 2)
                      )
                    : !1)),
                g(u, !0) && this.pinch(k))
              : m && this.reset())
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      ...
      colorizeItem: function (d, c) {
        d.legendGroup[c ? "removeClass" : "addClass"](
      ...
      positionItem: function (a) {
        ...
        (a = a.legendGroup) &&
          a.element &&
          a.translate(c ? e : this.legendWidth - e - 2 * d - 4, b);
        h && ((h.x = e), (h.y = b));
      },
      ...
      positionCheckboxes: function (a) {
        ...
        c &&
          ((d = c.translateY),
          m(this.allItems, function (h) {
            var g = h.checkbox,
              l;
            g &&
              ((l = d + e + g.y + (a || 0) + 3),
              A(g, {
                left: c.translateX + h.checkboxOffset + g.x - 20 + "px",
                top: l + "px",
                display: l > d - 6 && l < d + b - 6 ? "" : "none",
              }));
          }));
      },
      ...
      setText: function (d) {
        ...
        d.legendItem.attr({
          text: c.labelFormat
            ? a.format(c.labelFormat, d)
            : c.labelFormatter.call(d),
        });
      },
      renderItem: function (a) {
          ...
          ((a.legendGroup = d
            ...
            .addClass(
              "highcharts-" +
                ...
                a.colorIndex +
                (C ? " " + C : "") +
                (f ? " highcharts-series-" + a.index : "")
            )
            .attr({ zIndex: 1 })
            .add(this.scrollGroup)),
          (a.legendItem = u =
            d
              .text("", m ? h + g : -g, this.baseline || 0, N)
              .css(q(a.visible ? l : n))
              .attr({ align: m ? "left" : "right", zIndex: 2 })
              .add(a.legendGroup)),
          this.baseline ||
            ((h = l.fontSize),
            (this.fontMetrics = d.fontMetrics(h, u)),
            (this.baseline = this.fontMetrics.f + 3 + I),
            u.attr("y", this.baseline)),
          (this.symbolHeight = b.symbolHeight || this.fontMetrics.f),
          t.drawLegendSymbol(this, a),
          this.setItemEvents && this.setItemEvents(a, u, N),
          J && this.createCheckboxForItem(a));
        ...
        e &&
          this.itemX - r + l > (p || c.spacingBox.width - 2 * r - b.x) &&
          ((this.itemX = r),
          (this.itemY += I + this.lastLineHeight + E),
        ...
        e
          ? (this.itemX += l)
          : ((this.itemY += I + d + E), (this.lastLineHeight = d));
        this.offsetWidth =
      ...
      getAllItems: function () {
        ...
        m(this.chart.series, function (c) {
          var d = c && c.options;
          c &&
            v(d.showInLegend, F(d.linkedTo) ? !1 : void 0, !0) &&
            (a = a.concat(
          ...
          m(
            ...
            function (h, g) {
              h.test(e) &&
                ...
                (d[k[g]] = Math.max(
                  d[k[g]],
                  d.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] +
                    [1, -1, -1, 1][g] * b[g % 2 ? "x" : "y"] +
                    v(b.margin, 12) +
                    c[g]
                ));
      ...
      render: function () {
        ...
        a.lastItemY = 0;
        b ||
          ((a.group = b = e.g("legend").attr({ zIndex: 7 }).add()),
          (a.contentGroup = e.g().attr({ zIndex: 1 }).add(b)),
        ...
        0 < k &&
          ...
          (B[B.isNew ? "attr" : "animate"](
            B.crisp({ x: 0, y: 0, width: k, height: l }, B.strokeWidth())
          ),
          (B.isNew = !1));
        B[n ? "show" : "hide"]();
        a.legendWidth = k;
      ...
      handleOverflow: function (a) {
        ...
        E.length = 0;
        a > d && !1 !== r.enabled
          ? ((this.clipHeight = l = Math.max(d - 20 - this.titleHeight - g, 0)),
            ...
            m(u, function (a, b) {
              ...
              var f = E.length;
              if (!f || (c - E[f - 1] > l && (I || c) !== E[f - 1]))
                E.push(I || c), f++;
              b === u.length - 1 && c + a - E[f - 1] > l && E.push(c);
              c !== I && (I = c);
            }),
            n ||
              ((n = c.clipRect = b.clipRect(0, g, 9999, 0)),
              c.contentGroup.clip(n)),
            f(l),
            p ||
              ((this.nav = p = b.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = b
                .symbol("triangle", 0, 0, q, q)
                .on("click", function () {
                  c.scroll(-1, k);
                })
                .add(p)),
      ...
      scroll: function (a, c) {
        ...
        0 < a &&
          ...
          this.up
            .attr({ fill: 1 === a ? h.inactiveColor : h.activeColor })
            .css({ cursor: 1 === a ? "default" : "pointer" }),
          this.down
            .attr({ fill: a === b ? h.inactiveColor : h.activeColor })
            .css({ cursor: a === b ? "default" : "pointer" }),
          (c = -d[a - 1] + this.initialItemY),
    ...
    a.LegendSymbolMixin = {
      drawRectangle: function (a, c) {
        ...
        c.legendSymbol = this.chart.renderer
          .rect(
            b ? (a.symbolWidth - d) / 2 : 0,
            a.baseline - d + 1,
            b ? d : a.symbolWidth,
            d,
            v(a.options.symbolRadius, d / 2)
          )
      ...
      drawLineMarker: function (a) {
        ...
        d &&
          !1 !== d.enabled &&
          ((c = Math.min(v(d.radius, h), h)),
          0 === this.symbol.indexOf("url") &&
            ((d = q(d, { width: e, height: e })), (c = 0)),
          (this.legendSymbol = d =
            g
              .symbol(this.symbol, b / 2 - c, a - c, 2 * c, 2 * c, d)
              .addClass("highcharts-point")
              .add(l)),
          (d.isMarker = !0));
      },
  ...
  (function (a) {
    ...
    d(P.prototype, {
      ...
      redraw: function (b) {
        ...
        n(f, function (a) {
          a.isDirty &&
            ...
            (a.updateTotals && a.updateTotals(), (h = !0));
      ...
      layOutTitles: function (a) {
        ...
        n(
          ...
          function (a) {
            ...
            c &&
              ((h = p.style.fontSize),
              (h = f.fontMetrics(h, c).b),
              c
                .css({ width: (p.width || e.width + p.widthAdjust) + "px" })
                .align(d({ y: a + h }, p), !1, "spacingBox"),
              p.floating ||
                p.verticalAlign ||
                (b = Math.ceil(b + c.getBBox(p.useHTML).height)));
          },
          this
        );
        ...
        !this.isDirtyBox &&
          c &&
          ((this.isDirtyBox = c),
          this.hasRendered && E(a, !0) && this.isDirtyBox && this.redraw());
      },
      ...
      temporaryDisplay: function (c) {
        ...
        if (c)
          for (; f && f.style; )
            f.hcOrigStyle && (a.css(f, f.hcOrigStyle), delete f.hcOrigStyle),
              (f = f.parentNode);
        else
          for (; f && f.style; )
            "none" === b(f, "display", !1) &&
      ...
      getContainer: function () {
        ...
        this.renderer = new (a[f.renderer] || O)(
          b,
          e,
          p,
          null,
      ...
      getMargins: function (a) {
        ...
        f &&
          ...
          (this.plotTop = Math.max(
            this.plotTop,
            f + this.options.title.margin + b[0]
          ));
      ...
      setChartSize: function (a) {
        ...
        this.plotHeight = k = Math.max(
          0,
          Math.round(e - r - this.marginBottom)
        );
        ...
        this.clipBox = {
          ...
          height: Math.max(0, Math.floor(this.plotSizeY - b(2) - f)),
        };
        a ||
      ...
      resetMargins: function () {
        ...
        n(["margin", "spacing"], function (c) {
          var f = b[c],
            d = H(f) ? f : [f, f, f, f];
          n(["Top", "Right", "Bottom", "Left"], function (f, e) {
            a[c][e] = E(b[c + f], d[e]);
          });
        });
        n(r, function (b, c) {
      ...
      drawChartBox: function () {
        ...
        r &&
          (l
            ? l.animate(q)
            : (this.plotBGImage = b.image(r, k, m, E, w).add()));
        I
          ? I.animate({ width: z.width, height: z.height })
      ...
      linkSeries: function () {
        ...
        n(b, function (b) {
          ...
          l(c) &&
            ...
            (b.linkedParent = c),
            (b.visible = E(b.options.visible, c.options.visible, b.visible)));
        });
      },
      ...
      isReadyToRender: function () {
        var a = this;
        return R || N != N.top || "complete" === m.readyState
          ? !0
  ...
  (function (a) {
    ...
    a.Point.prototype = {
      init: function (a, e, g) {
        ...
        a.options.colorByPoint
          ? ((e = a.options.colors || a.chart.options.colors),
            (this.color = this.color || e[a.colorCounter]),
            (e = e.length),
            (g = a.colorCounter),
            a.colorCounter++,
      ...
      applyOptions: function (a, e) {
        ...
        void 0 === this.x &&
          h &&
          (this.x = void 0 === e ? h.autoIncrement(this) : e);
        return this;
      },
      optionsToObject: function (a) {
        ...
        if (q(a) || null === a) e[c[0]] = a;
          ...
          for (
            ...
            a.length > g &&
            ((h = typeof a[0]),
            "string" === h ? (e.name = a[0]) : "number" === h && (e.x = a[0]),
            b++);
            m < g;
          ...
          "object" === typeof a &&
            ((e = a),
            a.dataLabels && (h._hasPointLabels = !0),
            a.marker && (h._hasPointMarkers = !0));
        return e;
      },
      ...
      },
      {
          ...
          u(b.axisTypes || [], function (f) {
            u(d[f], function (a) {
              ...
              if (
                c[f] === e.index ||
                (void 0 !== c[f] && c[f] === e.id) ||
                (void 0 === c[f] && 0 === e.index)
              )
                b.insert(a.series), (b[f] = a), (a.isDirty = !0);
            });
        ...
        autoIncrement: function () {
          ...
          d &&
            ((a = new g(b)),
            "day" === d
              ? (a = +a[g.hcSetDate](a[g.hcGetDate]() + c))
              : "month" === d
              ? (a = +a[g.hcSetMonth](a[g.hcGetMonth]() + c))
              : "year" === d &&
                (a = +a[g.hcSetFullYear](a[g.hcGetFullYear]() + c)),
            (c = a - b));
          this.xIncrement = b + c;
          return b;
        },
        setOptions: function (a) {
          ...
          this.stickyTracking = H(
            a.stickyTracking,
            f[this.type] && f[this.type].stickyTracking,
            f.series && f.series.stickyTracking,
          ...
          if (
            ...
            if (E && r > E) {
              ...
              for (h = 0; h < r; h++)
                void 0 !== d[h] &&
                  ((m = { series: f }),
                  f.pointClass.prototype.applyOptions.apply(m, [d[h]]),
                  f.updateParallelArrays(m, h));
            b(y[0]) && a.error(14, !0);
            f.data = [];
        ...
        processData: function (b) {
          ...
          var n = this.getExtremesFromAll || r.getExtremesFromAll,
            ...
            q,
            w;
          if (k && !this.isDirty && !l.isDirty && !this.yAxis.isDirty && !b)
            return !1;
          l && ((b = l.getExtremes()), (q = b.min), (w = b.max));
          if (k && this.sorted && !n && (!g || e > g || this.forceCrop))
            if (c[e - 1] < q || c[0] > w) (c = []), (d = []);
            else if (c[0] < q || c[e - 1] > w)
              (f = this.cropData(this.xData, this.yData, q, w)),
                (c = f.xData),
                (d = f.yData),
                (f = f.start),
                (h = !0);
          for (g = c.length || 1; --g; )
            (e = m ? r(c[g]) - r(c[g - 1]) : c[g] - c[g - 1]),
              0 < e && (void 0 === p || e < p)
                ? (p = e)
        ...
        generatePoints: function () {
          ...
          for (q = 0; q < l; q++)
            (r = g + q),
              n
                ? ((k = new h().init(this, [f[q]].concat(B(e[q])))),
                  (k.dataGroup = this.groupMap[q]))
                : (k = c[r]) ||
                  void 0 === b[r] ||
                  (c[r] = k = new h().init(this, b[r], f[q])),
              k && ((k.index = r), (m[q] = k));
          this.options.keys = a;
          if (c && (l !== (d = c.length) || n))
            for (q = 0; q < d; q++)
        ...
        getExtremes: function (a) {
          ...
          for (k = 0; k < e; k++)
            if (
              ...
              (g =
                (w(n, !0) || c(n)) &&
                (!b.positiveValuesOnly || n.length || 0 < n)),
              (r =
        ...
        translate: function () {
          ...
          for (a = 0; a < h; a++) {
            ...
            var C =
                b &&
                f.stacks[
                  (this.negStacks && A < (k ? 0 : n) ? "-" : "") + this.stackKey
                ],
              F;
            ...
            D.plotX = q = m(
              Math.min(
                Math.max(
                  -1e5,
                  c.translate(M, 0, 0, 0, 1, g, "flags" === this.type)
                ),
                1e5
              )
            );
            b &&
              ...
              C &&
              C[M] &&
              ((B = this.getStackIndicator(B, M, this.index)),
              (F = C[M]),
              (A = F.points[B.key]),
              (z = A[0]),
              (A = A[1]),
              z === k && B.key === C[M].base && (z = H(n, f.min)),
              f.positiveValuesOnly && 0 >= z && (z = null),
              (D.total = D.stackTotal = F.total),
              (D.percentage = F.total && (D.y / F.total) * 100),
              (D.stackY = A),
              F.setOffset(this.pointXOffset || 0, this.barW || 0));
            D.yBottom = v(z) ? f.translate(z, 0, 1, 0, 1) : null;
            l && (A = this.modifyValue(A, D));
            D.plotY = z =
              "number" === typeof A && Infinity !== A
                ? Math.min(Math.max(-1e5, f.translate(A, 0, 1, 0, 1)), 1e5)
                : void 0;
            D.isInside =
              void 0 !== z && 0 <= z && z <= f.len && 0 <= q && q <= c.len;
            D.clientX = r ? m(c.translate(M, 0, 0, 0, 1, g)) : q;
            D.negative = D.y < (n || 0);
            D.category = d && void 0 !== d[D.x] ? d[D.x] : D.x;
            D.isNull ||
              (void 0 !== y && (u = Math.min(u, Math.abs(q - y))), (y = q));
        ...
        setClip: function (a) {
          ...
          a &&
            !g.count[this.index] &&
            ((g.count[this.index] = !0), (g.count.length += 1));
          !1 !== c.clip &&
          ...
          a ||
            (g.count[this.index] &&
              (delete g.count[this.index], --g.count.length),
            0 === g.count.length &&
              l &&
              b[l] &&
              (e || (b[l] = b[l].destroy()),
              b[l + "m"] && (b[l + "m"] = b[l + "m"].destroy())));
        },
        animate: function (a) {
          var b = this.chart,
          ...
          a
            ...
            : ((d = this.sharedClipKey),
              (a = b[d]) && a.animate({ width: b.plotSizeX }, c),
              b[d + "m"] && b[d + "m"].animate({ width: b.plotSizeX + 99 }, c),
              (this.animate = null));
        },
          ...
          if (!1 !== h.enabled || this._hasPointMarkers)
            for (d = 0; d < a.length; d++)
              (f = a[d]),
                ...
                (l = f.marker || {}),
                (g = !!f.marker),
                (r = (m && void 0 === l.enabled) || l.enabled),
                (n = f.isInside),
                r && w(c) && null !== f.y
                  ? ((c = H(l.symbol, this.symbol)),
                    (f.hasImage = 0 === c.indexOf("url")),
                    (r = this.markerAttribs(f, f.selected && "select")),
                    e
                      ? e[n ? "show" : "hide"](!0).animate(r)
                      : n &&
                        (0 < r.width || f.hasImage) &&
                        (f.graphic = e =
                          b.renderer
                            .symbol(c, r.x, r.y, r.width, r.height, g ? l : h)
                            .add(k)),
                    e && e.attr(this.pointAttribs(f, f.selected && "select")),
                    e && e.addClass(f.getClassName(), !0))
                  : e && (f.graphic = e.destroy());
        },
        ...
        pointAttribs: function (a, b) {
          ...
          b &&
            ...
            (d = H(
              b.lineWidth,
              c.lineWidth,
              d + H(b.lineWidthPlus, c.lineWidthPlus, 0)
            )),
        ...
        destroy: function () {
          ...
          u(a.axisTypes || [], function (b) {
            (k = a[b]) &&
              k.series &&
              (h(k.series, a), (k.isDirty = k.forceRedraw = !0));
          });
          ...
          u(d, function (f, d) {
            ...
            h
              ...
              : c.length &&
                ...
                (h = a[e].attr(h).shadow(2 > d && b.shadow)));
        ...
        applyZones: function () {
          ...
          d.length &&
            ...
            u(d, function (d, p) {
              ...
              e = Math.min(
                Math.max(Math.round(k.toPixels(H(d.value, m.max), !0)), 0),
                n
              );
              ...
              v = Math.max(f, e);
              k.isXAxis
                ? ((l = { x: w ? v : B, y: 0, width: y, height: n }),
                  z || (l.x = b.plotHeight - l.x))
                : ((l = { x: 0, y: w ? v : B, width: n, height: y }),
                  z && (l.y = b.plotWidth - l.y));
              w &&
                c.isVML &&
                (l = k.isXAxis
                  ? { x: 0, y: q ? B : v, height: l.width, width: b.chartWidth }
                  : {
              ...
              h[p]
                ? h[p].animate(l)
                : ((h[p] = c.clipRect(l)),
                  g && a["zone-graph-" + p].clip(h[p]),
                  r && a["zone-area-" + p].clip(h[p]));
              D = d.value > m.max;
            }),
            (this.clips = h));
        },
        ...
        render: function () {
          ...
          a.markerGroup = a.plotGroup("markerGroup", "markers", e, h, g);
          f && a.animate(!0);
          ...
          function a(c, f, d) {
            ...
            if ((h = c && c.length))
              return (
                ...
                {
                  point: c[h],
                  left: a(c.slice(0, h), f + 1, d),
                  right: a(c.slice(h + 1), f + 1, d),
                }
              );
          }
        ...
        searchKDTree: function (a, b) {
          function c(a, b, l, g) {
            var r = b.point,
              ...
              k,
              m = r;
            k = v(a[f]) && v(r[f]) ? Math.pow(a[f] - r[f], 2) : null;
  ...
  (function (a) {
    function C(a, e, g, d, c) {
      ...
      this.alignOptions = {
        align: e.align || (h ? (g ? "left" : "right") : "center"),
        verticalAlign: e.verticalAlign || (h ? "middle" : g ? "bottom" : "top"),
        y: u(e.y, h ? 4 : g ? 14 : -6),
        x: u(e.x, h ? (g ? -6 : 6) : 0),
      };
      ...
      setOffset: function (a, e) {
        ...
        if ((e = this.label))
          e.align(this.alignOptions, null, c),
            (c = e.alignAttr),
            e[
              !1 === this.options.crop || d.isInsidePlot(c.x, c.y)
                ? "show"
                : "hide"
            ](!0);
      },
    ...
    G.prototype.getStacks = function () {
      ...
      k(a.series, function (e) {
        !e.options.stacking ||
          ...
          (e.stackKey = e.type + u(e.options.stack, ""));
      });
    };
    A.prototype.buildStacks = function () {
      ...
      if (!this.isXAxis) {
        ...
        if (this.usePercentage) for (c = 0; c < d; c++) a[c].setPercentStacks();
      }
    };
    A.prototype.renderStackTotals = function () {
      ...
      d ||
        (this.stackTotalGroup = d =
          e.g("stack-labels").attr({ visibility: "visible", zIndex: 6 }).add());
    ...
    a.prototype.setStackedPoints = function () {
      if (
        ...
        for (A = 0; A < d; A++)
          (f = a[A]),
            (t = e[A]),
            (M = this.getStackIndicator(M, f, this.index)),
            (I = M.key),
            (E = (p = l && t < (b ? 0 : k)) ? H : v),
            r[E] || (r[E] = {}),
            r[E][f] ||
              (z[E] && z[E][f]
                ? ((r[E][f] = z[E][f]), (r[E][f].total = null))
                : (r[E][f] = new C(B, B.options.stackLabels, p, f, q))),
            (E = r[E][f]),
            null !== t &&
              ((E.points[I] = E.points[this.index] = [u(E.cum, b)]),
              m(E.cum) || (E.base = I),
              (E.touched = B.stacksTouched),
              0 < M.index &&
                !1 === this.singleStacks &&
                (E.points[I][0] = E.points[this.index + "," + f + ",0"][0])),
            "percent" === c
              ? ((p = p ? v : H),
                l && r[p] && r[p][f]
                  ? ((p = r[p][f]),
                    (E.total = p.total =
                      Math.max(p.total, E.total) + Math.abs(t) || 0))
                  : (E.total = F(E.total + (Math.abs(t) || 0))))
              : (E.total = F(E.total + (t || 0))),
            (E.cum = u(E.cum, b) + (t || 0)),
            null !== t && (E.points[I].push(E.cum), (g[A] = E.cum));
    ...
    a.prototype.setPercentStacks = function () {
      ...
      k([e, "-" + e], function (e) {
        for (var b = d.length, h, k; b--; )
          if (
            ((h = d[b]),
            (c = a.getStackIndicator(c, h, a.index, e)),
            (h = (k = g[e] && g[e][h]) && k.points[c.key]))
          )
  ...
  (function (a) {
    ...
    v(a.Chart.prototype, {
      ...
      update: function (a, d) {
        ...
        if (n) {
          ...
          "alignTicks" in n && (m = !0);
          w(n, function (a, b) {
            -1 !== h("chart." + b, l.propsRequireUpdateSeries) && (q = !0);
            -1 !== h(b, l.propsRequireDirtyBox) && (l.isDirtyBox = !0);
          });
        ...
        k("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
          a[b] &&
            k(B(a[b]), function (a, c) {
              (c = (g(a.id) && l.get(a.id)) || l[b][c]) &&
                c.coll === b &&
                c.update(a, !1);
            });
        });
        ...
        q &&
          k(l.series, function (a) {
            a.update({}, !1);
          });
        a.loading && c(!0, l.options.loading, a.loading);
        m = n && n.width;
        n = n && n.height;
        (e(m) && m !== l.chartWidth) || (e(n) && n !== l.chartHeight)
          ? l.setSize(m, n)
          : b(d, !0) && l.redraw();
      },
    ...
    v(D.prototype, {
      addPoint: function (a, c, d, e) {
        ...
        d &&
          (l[0] && l[0].remove
            ? l[0].remove(!1)
            : (l.shift(), this.updateParallelArrays(k, "shift"), r.shift()));
      ...
      update: function (a, d) {
        ...
        a = c(
          l,
          { animation: !1, index: e.index, pointStart: e.xData[0] },
          { data: e.options.data },
          a
        );
        e.remove(!1, null, !1);
    ...
    v(G.prototype, {
      ...
      remove: function (a) {
        for (
          var c = this.chart, e = this.coll, h = this.series, l = h.length;
          l--;
      ...
      { softThreshold: !1, threshold: 0 },
      {
        ...
        getStackPoints: function () {
          ...
          if (this.options.stacking) {
            for (D = 0; D < n.length; D++) e[n[D].x] = n[D];
        ...
        getGraphPath: function (a) {
          var g = m.prototype.getGraphPath,
            ...
            B = function (e, l, g) {
              ...
              var r,
                ...
                k = !0;
              g || n
                ? ((r = (n ? e[0] : e[1]) + g), (m = e[0] + g), (k = !!n))
                : !u && a[l] && a[l].isNull && (r = m = D);
              void 0 !== r &&
                (c.push({
                  plotX: b,
                  plotY: null === r ? A : h.getThreshold(r),
                  isNull: k,
                  isCliff: !0,
                }),
                d.push({
                  plotX: b,
                  plotY: null === m ? A : h.getThreshold(m),
                  doCurve: !1,
                }));
            };
          a = a || this.points;
          ...
          for (e = 0; e < a.length; e++)
            if (
              ((n = a[e].isNull),
              (b = F(a[e].rectPlotX, a[e].plotX)),
              (l = F(a[e].yBottom, A)),
              !n || k)
            )
              k || B(e, e - 1, "left"),
                (n && !u && k) ||
                  (c.push(a[e]), d.push({ x: e, plotX: b, plotY: l })),
                k || B(e, e + 1, "right");
          e = g.call(this, c, !0, !0);
          d.reversed = !0;
          n = g.call(this, d, !0, !0);
        ...
        drawGraph: function () {
          ...
          A(this.zones, function (h, e) {
            u.push([
              "zone-area-" + e,
              "highcharts-area highcharts-zone-area-" + e + " " + h.className,
              h.color || a.color,
              h.fillColor || v.fillColor,
            ]);
          });
          A(u, function (h) {
            var e = h[0],
              ...
              : ((k = a[e] =
                  a.chart.renderer
                    ...
                    .attr({
                      fill: F(
                        h[3],
                        C(h[2]).setOpacity(F(v.fillOpacity, 0.75)).get()
                      ),
                      zIndex: 0,
                    })
                    .add(a.group)),
      ...
      {},
      {
        getPointSpline: function (a, G, F) {
          ...
          if (
            ...
            h += e;
            v > a && v > g
              ? ((v = Math.max(a, g)), (h = 2 * g - v))
              : v < a && v < g && ((v = Math.min(a, g)), (h = 2 * g - v));
            h > F && h > g
              ? ((h = Math.max(F, g)), (v = 2 * g - h))
              : h < F && h < g && ((h = Math.min(F, g)), (v = 2 * g - h));
            G.rightContX = u;
            G.rightContY = h;
          }
          G = [
            "C",
            C(k.rightContX, k.plotX),
            C(k.rightContY, k.plotY),
            C(q, m),
            C(v, g),
            m,
            g,
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          var u = Math.min(
            ...
            l = (u - 2 * v) / (q || 1),
            e = Math.min(
              e.maxPointWidth || g.len,
              k(e.pointWidth, l * (1 - 2 * e.pointPadding))
            );
          a.columnMetrics = {
            width: e,
            offset:
              (l - e) / 2 +
              (v + ((a.columnIndex || 0) + (c ? 1 : 0)) * l - u / 2) *
                (c ? -1 : 1),
          };
        ...
        translate: function () {
          ...
          G(a.points, function (d) {
            ...
            Math.abs(y) < b &&
              b &&
              ((y = b),
              (w = (!c.reversed && !d.negative) || (c.reversed && d.negative)),
              (q = Math.abs(q - m) > b ? g - b : m - (w ? b : 0)));
            d.barX = n;
            d.pointWidth = u;
            d.tooltipPos = e.inverted
              ? [c.len + c.pos - e.plotLeft - h, a.xAxis.len - n - p / 2, y]
              : [n + p / 2, h + c.pos - e.plotTop, y];
            d.shapeType = "rect";
            d.shapeArgs = a.crispCol.apply(
              a,
              d.isNull ? [n, m, p, 0] : [n, q, p, y]
            );
          });
        },
        getSymbol: a.noop,
        ...
        pointAttribs: function (a, e) {
          ...
          e &&
            ...
            (b =
              a.color ||
              (void 0 !== e && A(b).brighten(a.brightness).get()) ||
              b),
            (m = a[d] || m),
            (q = a[k] || q),
            (c = a.dashStyle || c));
        ...
        drawPoints: function () {
          ...
          G(a.points, function (b) {
            ...
            if (m(b.plotY) && null !== b.y) {
              ...
              h.attr(a.pointAttribs(b, b.selected && "select")).shadow(
                k.shadow,
                null,
          ...
          u &&
            (a
              ? ((h.scaleY = 0.001),
                (a = Math.min(
                  g.pos + g.len,
                  Math.max(g.pos, g.toPixels(d.threshold))
                )),
                c ? (h.translateX = a - g.len) : (h.translateY = a),
                e.group.attr(h))
              : ((h[c ? "translateX" : "translateY"] = g.pos),
                e.group.animate(
                  h,
                  F(C(e.options.animation), {
                    step: function (a, c) {
                      e.group.attr({ scaleY: Math.max(0.001, c.pos) });
                    },
                  })
                ),
                (e.animate = null)));
    ...
    u(
      ...
      },
      {
          ...
          a ||
            (G(d, function (a) {
              var b = a.graphic,
                d = a.shapeArgs;
              b &&
                (b.attr({ r: a.startR || e.center[3] / 2, start: c, end: c }),
                b.animate(
        ...
        updateTotals: function () {
          ...
          for (a = 0; a < c; a++)
            (h = d[a]),
              (h.percentage = 0 < g && (h.visible || !b) ? (h.y / g) * 100 : 0),
              (h.total = g);
        },
        generatePoints: function () {
        ...
        translate: function (a) {
          ...
          var e = 0,
            ...
            q =
              (this.endAngleRad =
                (Math.PI / 180) * (k(d.endAngle, q + 360) - 90)) - l,
            u = this.points,
            r,
          ...
          this.getX = function (b, c, d) {
            m = Math.asin(
              Math.min((b - a[1]) / (a[2] / 2 + d.labelDistance), 1)
            );
            return (
              a[0] + (c ? -1 : 1) * Math.cos(m) * (a[2] / 2 + d.labelDistance)
            );
          };
          for (v = 0; v < p; v++) {
            E = u[v];
            E.labelDistance = k(
              E.options.dataLabels && E.options.dataLabels.distance,
              z
            );
            ...
            b = l + e * q;
            if (!d || E.visible) e += E.percentage / 100;
            h = l + e * q;
            E.shapeType = "arc";
            E.shapeArgs = {
              x: a[0],
            ...
            h = (Math.cos(m) * a[2]) / 2;
            r = (Math.sin(m) * a[2]) / 2;
            E.tooltipPos = [a[0] + 0.7 * h, a[1] + 0.7 * r];
            E.half = m < -Math.PI / 2 || m > Math.PI / 2 ? 1 : 0;
            E.angle = m;
            b = Math.min(g, E.labelDistance / 5);
            E.labelPos = [
              a[0] + h + Math.cos(m) * E.labelDistance,
              a[1] + r + Math.sin(m) * E.labelDistance,
              a[0] + h + Math.cos(m) * b,
              a[1] + r + Math.sin(m) * b,
              a[0] + h,
              a[1] + r,
              0 > E.labelDistance ? "center" : E.half ? "right" : "left",
              m,
            ];
          }
        },
        ...
        drawPoints: function () {
          ...
          G(a.points, function (e) {
            if (!e.isNull) {
              ...
              m && m.attr(d);
              h = a.pointAttribs(e, e.selected && "select");
              c
                ? c.setRadialReference(a.center).attr(h).animate(F(b, d))
                : ((e.graphic = c =
                    g[e.shapeType](b)
                      .setRadialReference(a.center)
                      .attr(d)
                      .add(a.group)),
                  e.visible || c.attr({ visibility: "hidden" }),
                  c.attr(h).attr({ "stroke-linejoin": "round" }).shadow(k, m));
      ...
      },
      {
        ...
        setVisible: function (a, g) {
          ...
          a !== d.visible &&
            ...
            (c.options.data[m(d, c.data)] = d.options),
            G(
            ...
            d.legendItem && e.legend.colorizeItem(d, a),
        ...
        haloPath: function (a) {
          ...
          return this.sliced || !this.visible
            ...
            : this.series.chart.renderer.symbols.arc(
                ...
                e.r + a,
                e.r + a,
                { innerR: this.shapeArgs.r, start: e.start, end: e.end }
              );
        },
      }
    );
  ...
  (function (a) {
        ...
        for (c = a.length; c--; )
          (g = a[c]),
            (m =
              ...
              2),
            (g.pos = Math.min(Math.max(0, m - g.size / 2), e - g.size));
        c = a.length;
        for (g = !1; c--; )
          0 < c &&
            a[c - 1].pos + a[c - 1].size > a[c].pos &&
            ((a[c - 1].size += a[c].size),
            (a[c - 1].targets = a[c - 1].targets.concat(a[c].targets)),
            a[c - 1].pos + a[c - 1].size > e &&
              (a[c - 1].pos = e - a[c - 1].size),
            a.splice(c, 1),
            (g = !0));
      }
      c = 0;
    ...
    e.prototype.drawDataLabels = function () {
      ...
      if (b.enabled || c._hasPointLabels)
        c.dlProcessOptions && c.dlProcessOptions(b),
          (r = c.plotGroup(
            "dataLabelsGroup",
            "data-labels",
            n && !l ? "hidden" : "visible",
          ...
          n &&
            (r.attr({ opacity: +l }),
            l ||
              C(c, "afterAnimate", function () {
                c.visible && r.show(!0);
                r[d.animation ? "animate" : "attr"](
                  { opacity: 1 },
                  { duration: 200 }
                );
              })),
          ...
          F(e, function (e) {
            ...
            if ((l = u(h && h.enabled, k.enabled) && null !== e.y))
              (b = q(k, h)),
                (n = e.getLabelConfig()),
                (m = b.format ? g(b.format, n) : b.formatter.call(n, b)),
                (z = b.style),
                (n = b.rotation),
                (z.color = u(b.color, z.color, c.color, "#000000")),
                "contrast" === z.color &&
                  ((e.contrastColor = v.getContrast(e.color || c.color)),
                  (z.color =
                    b.inside || 0 > u(e.labelDistance, b.distance) || d.stacking
                      ? e.contrastColor
                      : "#000000")),
                d.cursor && (z.cursor = d.cursor),
                (f = {
            ...
            !p || (l && G(m))
              ? l &&
                ...
                p.attr(f),
                p.css(z).shadow(b.shadow),
                p.added || p.add(r),
                c.alignDataLabel(e, p, b, null, w))
              : ((e.dataLabel = p = p.destroy()),
                t && (e.connector = t.destroy()));
          });
    };
    e.prototype.alignDataLabel = function (a, d, b, e, g) {
      var c = this.chart,
        ...
        v =
          this.visible &&
          (a.series.forceDL ||
            c.isInsidePlot(k, Math.round(r), h) ||
            (e && c.isInsidePlot(k, h ? e.x + 1 : e.y + e.height - 1, h))),
        y = "justify" === u(b.overflow, "justify");
      if (
        v &&
        ((q = b.style.fontSize),
        (q = c.renderer.fontMetrics(q, d).b),
        (e = m(
          {
            x: h ? c.plotWidth - r : k,
            y: Math.round(h ? c.plotHeight - k : r),
            width: 0,
            height: 0,
          },
          e
        )),
        m(b, { width: n.width, height: n.height }),
        p
          ? ((y = !1),
            (k = c.renderer.rotCorr(q, p)),
            (k = {
              x: e.x + b.x + e.width / 2 + k.x,
              y:
                e.y +
                b.y +
                { top: 0, middle: 0.5, bottom: 1 }[b.verticalAlign] * e.height,
            }),
            d[g ? "attr" : "animate"](k).attr({ align: w }),
            (r = (p + 720) % 360),
            (r = 180 < r && 360 > r),
            "left" === w
              ? (k.y -= r ? n.height : 0)
              ...
              : "right" === w && ((k.x -= n.width), (k.y -= r ? 0 : n.height)))
          : (d.align(b, null, e), (k = d.alignAttr)),
        y
          ? (a.isLabelJustified = this.justifyDataLabel(d, b, k, n, e, g))
          : u(b.crop, !0) &&
            (v =
              c.isInsidePlot(k.x, k.y) &&
              c.isInsidePlot(k.x + n.width, k.y + n.height)),
        b.shape && !p)
      )
        d[g ? "attr" : "animate"]({
    ...
    e.prototype.justifyDataLabel = function (a, d, b, e, g, h) {
      ...
      n = b.x + e.width - p;
      n > c.plotWidth &&
        ("left" === k ? (d.align = "right") : (d.x = c.plotWidth - n),
        (q = !0));
      n = b.y + p;
      0 > n &&
        ("bottom" === m ? (d.verticalAlign = "top") : (d.y = -n), (q = !0));
      n = b.y + e.height - p;
      n > c.plotHeight &&
        ("top" === m ? (d.verticalAlign = "bottom") : (d.y = c.plotHeight - n),
        (q = !0));
    ...
    n.pie &&
      ((n.pie.prototype.drawDataLabels = function () {
        ...
        c.visible &&
          ...
          e.prototype.drawDataLabels.apply(c),
          F(d, function (a) {
            a.dataLabel &&
              a.visible &&
              (K[a.half].push(a), (a.dataLabel._pos = null));
          }),
          F(K, function (d, e) {
            var l,
              n,
            ...
            if (u)
              for (
                c.sortByAngle(d, e - 0.5),
                  0 < c.maxLabelDistance &&
                    ((l = Math.max(0, v - p - c.maxLabelDistance)),
                    (n = Math.min(v + p + c.maxLabelDistance, g.plotHeight)),
                    F(d, function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                ...
                (b = d[P]),
                  ...
                  w && G(w[n])
                    ? void 0 === w[n].pos
                      ? (O = "hidden")
                      : ((t = w[n].size), (N = b.top + w[n].pos))
                    : (N = l),
                  delete b.positionIndex,
                  (J = h.justify
                    ? q[0] + (e ? -1 : 1) * (p + b.labelDistance)
                    : c.getX(N < b.top + 2 || N > b.bottom - 2 ? l : N, e, b)),
                  (C._attr = { visibility: O, align: f[6] }),
                  (C._pos = {
                    x: J + h.x + ({ left: k, right: -k }[f[6]] || 0),
                    y: N + h.y - 10,
                  }),
                  (f.x = J),
                  (f.y = N),
                  ...
                  (l = null),
                  J - L < k
                    ? ((l = Math.round(L - J + k)), (x[3] = Math.max(l, x[3])))
                    : J + L > m - k &&
                      ((l = Math.round(J + L - m + k)),
                      (x[1] = Math.max(l, x[1]))),
                  0 > N - t / 2
                    ? (x[0] = Math.max(Math.round(-N + t / 2), x[0]))
                    : N + t / 2 > r &&
                      (x[2] = Math.max(Math.round(N + t / 2 - r), x[2])),
                  (C.sideOverflow = l);
          }),
          0 === A(x) || this.verifyDataLabelOverflow(x)) &&
        ...
        F(
          ...
          function (a) {
            ...
            c &&
              ...
              ((a = c._pos)
                ? (c.sideOverflow &&
                    ((c._attr.width = c.getBBox().width - c.sideOverflow),
                    c.css({
      ...
      (n.pie.prototype.alignDataLabel = v),
      (n.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        l ||
          (null !== d[0]
            ? (g = Math.max(c[2] - Math.max(a[1], a[3]), e))
            : ((g = Math.max(c[2] - a[1] - a[3], e)),
              (c[0] += (a[3] - a[1]) / 2)),
          null !== d[1]
            ? (g = Math.max(Math.min(g, c[2] - Math.max(a[0], a[2])), e))
            : ((g = Math.max(Math.min(g, c[2] - a[0] - a[2]), e)),
              (c[1] += (a[0] - a[2]) / 2)),
          g < c[2]
            ? ((c[2] = g),
              (c[3] = Math.min(h(b.innerSize || 0, g), g)),
              this.translate(c),
    ...
    n.column &&
      (n.column.prototype.alignDataLabel = function (a, d, b, g, h) {
        ...
        k &&
          ...
          n ||
            (c
              ? ((g.x += m ? 0 : g.width), (g.width = 0))
              : ((g.y += m ? g.height : 0), (g.height = 0))));
        b.align = u(b.align, !c || n ? "center" : m ? "right" : "left");
        b.verticalAlign = u(
          b.verticalAlign,
          c || n ? "middle" : m ? "top" : "bottom"
        );
  ...
  (function (a) {
    ...
    H = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        var a = this,
          ...
          w = "rgba(192,192,192," + (D ? 0.0001 : 0.002) + ")";
        if (e && !c)
          for (q = e + 1; q--; )
            "M" === d[q] && d.splice(q + 1, 0, d[q + 1] - n, d[q + 2], "L"),
              ((q && "M" === d[q]) || q === e) &&
                d.splice(q, 0, "L", d[q - 2] + n, d[q - 1]);
        f
          ? f.attr({ d: d })
          : a.graph &&
            ((a.tracker = m
      ...
      zoom: function (a) {
        ...
        !a || a.resetSelection
          ...
          : k(a.xAxis.concat(a.yAxis), function (a) {
              var c = a.axis;
              d[c.isXAxis ? "zoomX" : "zoomY"] &&
                ((b = c.zoom(a.min, a.max)), c.displayBtn && (g = !0));
            });
        h = this.resetZoomButton;
        g && !h
          ? this.showResetZoom()
          : !g && e(h) && (this.resetZoomButton = h.destroy());
        b &&
          this.redraw(
            c(
      ...
      pan: function (a, b) {
        ...
        k("xy" === b ? [1, 0] : [1], function (b) {
          ...
          var d = b.horiz,
            ...
            f = Math.min(
              l.dataMin,
              b.toValue(b.toPixels(l.min) - b.minPixelPadding)
            ),
            m = Math.max(
              l.dataMax,
              b.toValue(b.toPixels(l.max) + b.minPixelPadding)
            ),
            n;
          n = f - h;
          0 < n && ((k += n), (h = f));
      ...
      select: function (a, b) {
        ...
        d.firePointEvent(
          ...
          function () {
            ...
            d.setState(a && "select");
            b ||
              k(g.getSelectedPoints(), function (a) {
                a.selected &&
                  a !== d &&
                  ((a.selected = a.options.selected = !1),
                  (e.options.data[h(a, e.data)] = a.options),
                  a.setState(""),
      ...
      setState: function (a, b) {
        ...
        if (
          !(
            ...
            !1 === l.enabled ||
            (a && (f || (m && !1 === n.enabled))) ||
            (a && u.states && u.states[a] && !1 === u.states[a].enabled)
          )
        ) {
          ...
          if (this.graphic)
            this.state &&
              ...
              y &&
                this.graphic.animate(
                  y,
                  c(v.options.chart.animation, n.animation, k.animation)
                ),
              t && t.hide();
          else {
            if (a && n) {
            ...
            t &&
              (t[a && v.isInsidePlot(d, e, v.inverted) ? "show" : "hide"](),
              (t.element.point = this));
          }
          (d = l.halo) && d.size
            ? (w ||
                (h.halo = w =
                  v.renderer.path().add((this.graphic || t).parentGroup)),
              w[b ? "animate" : "attr"]({ d: this.haloPath(d.size) }),
              w.attr({
                class:
                  "highcharts-halo highcharts-color-" +
                  c(this.colorIndex, h.colorIndex),
              }),
              (w.point = this),
              w.attr(
                q(
            ...
            : w &&
              w.point &&
              w.point.haloPath &&
              w.animate({ d: w.point.haloPath(0) });
          this.state = a;
        }
      },
      haloPath: function (a) {
    ...
    q(b.prototype, {
      ...
      setState: function (a) {
        ...
        if (
          b.state !== a &&
          (k([b.group, b.markerGroup, b.dataLabelsGroup], function (c) {
            c &&
          ...
          (b.state = a),
          !g[a] || !1 !== g[a].enabled) &&
          (a && (h = g[a].lineWidth || h + (g[a].lineWidthPlus || 0)),
          e && !e.dashstyle)
        )
          for (
            h = { "stroke-width": h },
              e.animate(
                h,
                c(b.chart.options.chart.animation, g[a] && g[a].animation)
              );
            b["zone-graph-" + d];
  ...
  (function (a) {
    ...
    C.prototype.matchResponsiveRule = function (a, k) {
      ...
      (
        ...
        function () {
          return (
            this.chartWidth <= g(m.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= g(m.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= g(m.minWidth, 0) &&
            this.chartHeight >= g(m.minHeight, 0)
          );
        }
      ...
      function q(g, e, n, d) {
        ...
        a.objectEach(g, function (a, b) {
          if (!d && -1 < G(b, ["series", "xAxis", "yAxis"]))
            for (g[b] = k(g[b]), n[b] = [], c = 0; c < g[b].length; c++)
              e[b][c] && ((n[b][c] = {}), q(a[c], e[b][c], n[b][c], d + 1));
          else
            m(a)
              ? ((n[b] = F(a) ? [] : {}), q(a, e[b] || {}, n[b], d + 1))
              : (n[b] = e[b] || null);
        });
      }
      var u = {};
