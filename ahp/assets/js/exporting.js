...
(function (k) {
  ...
  (function (f) {
    ...
    f.post = function (a, b, e) {
      var c = t(
        "form",
        n({ method: "post", action: a, enctype: "multipart/form-data" }, e),
        { display: "none" },
        p.body
      );
      F(b, function (a, b) {
    ...
    u(A.prototype, {
      sanitizeSVG: function (a, b) {
        if (b && b.exporting && b.exporting.allowHTML) {
          ...
          e &&
            e[1] &&
            ((e =
              '\x3cforeignObject x\x3d"0" y\x3d"0" width\x3d"' +
              b.chart.width +
              '" height\x3d"' +
              b.chart.height +
              '"\x3e\x3cbody xmlns\x3d"http://www.w3.org/1999/xhtml"\x3e' +
              e[1] +
              "\x3c/body\x3e\x3c/foreignObject\x3e"),
        ...
        a = a
          ...
          .replace(
            /<svg /,
            '\x3csvg xmlns:xlink\x3d"http://www.w3.org/1999/xlink" '
          )
          .replace(/ (NS[0-9]+\:)?href=/g, " xlink:href\x3d")
          .replace(/\n/, " ")
          .replace(/<\/svg>.*?$/, "\x3c/svg\x3e")
          .replace(
            /(fill|stroke)="rgba\(([ 0-9]+,[ 0-9]+,[ 0-9]+),([ 0-9\.]+)\)"/g,
            '$1\x3d"rgb($2)" $1-opacity\x3d"$3"'
          )
          .replace(/&nbsp;/g, "\u00a0")
          .replace(/&shy;/g, "\u00ad");
        return (a = a
          .replace(/<IMG /g, "\x3cimage ")
          .replace(/<(\/?)TITLE>/g, "\x3c$1title\x3e")
          .replace(/height=([^" ]+)/g, 'height\x3d"$1"')
          .replace(/width=([^" ]+)/g, 'width\x3d"$1"')
          .replace(/hc-svg-href="([^"]+)">/g, 'xlink:href\x3d"$1"/\x3e')
          .replace(/ id=([^" >]+)/g, ' id\x3d"$1"')
          .replace(/class=([^" >]+)/g, 'class\x3d"$1"')
          .replace(/ transform /g, " ")
      ...
      getSVG: function (a) {
        var b,
          ...
          g = n(this.options, a);
        p.createElementNS ||
          (p.createElementNS = function (a, b) {
        ...
        a &&
          h(["xAxis", "yAxis", "series"], function (c) {
            var d = {};
      ...
      getSVGForExport: function (a, b) {
        ...
        return this.getSVG(
          n({ chart: { borderRadius: 0 } }, e.chartOptions, b, {
            exporting: {
        ...
        l ||
          ((d[n] = l =
            t(
              "div",
              { className: a },
              { position: "absolute", zIndex: 1e3, padding: x + "px" },
              d.container
            )),
          (y = t("div", { className: "highcharts-menu" }, null, l)),
          v(
            y,
            u(
              {
            ...
            if (a) {
              ...
              a.separator
                ...
                : ((b = t(
                  ...
                  v(b, u({ cursor: "pointer" }, r.menuItemStyle)));
              d.exportDivElements.push(b);
            }
          }),
          d.exportDivElements.push(y, l),
          (d.exportMenuWidth = l.offsetWidth),
          (d.exportMenuHeight = l.offsetHeight));
        b = { display: "block" };
        e + d.exportMenuWidth > k
          ? (b.right = k - e - f - x + "px")
          : (b.left = e - x + "px");
        c + m + d.exportMenuHeight > q && "top" !== g.alignOptions.verticalAlign
          ? (b.bottom = q - c - x + "px")
          : (b.top = c + m - x + "px");
        v(l, b);
        d.openMenu = !0;
      ...
      addButton: function (a) {
        ...
        if (!1 !== c.enabled) {
          ...
          c.text && c.symbol
            ? (h.paddingLeft = C(h.paddingLeft, 25))
            : c.text || u(h, { width: c.width, height: c.height, padding: 0 });
          d = e
            .button(c.text, 0, 0, l, h, p, q)
          ...
          c.symbol &&
            ((g = e
              .symbol(c.symbol, c.symbolX - k / 2, c.symbolY - k / 2, k, k)
          ...
          d.add().align(
            u(c, { width: d.width, x: C(c.x, b.buttonOffset) }),
            !0,
            "spacingBox"
          );
          b.buttonOffset +=
            (d.width + c.buttonSpacing) * ("right" === c.align ? -1 : 1);
